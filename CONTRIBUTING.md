...
(`eu.opendpp-node:opendpp-sdk` on Maven Central), Python (`opendpp-sdk` on PyPI) — is **mechanically
generated from the public OpenDPP OpenAPI contract** and version-locked (major.minor) to it. The OpenDPP **product backend is a
