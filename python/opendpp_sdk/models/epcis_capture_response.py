...
class EpcisCaptureResponse(BaseModel):
    """
    ...
    """ # noqa: E501
    status: StrictStr
    captured: StrictInt = Field(description="How many events were persisted.")
    results: List[EpcisCaptureResponseResultsInner]
    errors: List[EpcisCaptureResponseErrorsInner]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["status", "captured", "results", "errors"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EpcisCaptureResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EpcisCaptureResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "results": [EpcisCaptureResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
            "errors": [EpcisCaptureResponseErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
