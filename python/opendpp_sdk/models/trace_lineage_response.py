...
class TraceLineageResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["success", "lineage"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TraceLineageResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TraceLineageResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "lineage": TraceLineageNode.from_dict(obj["lineage"]) if obj.get("lineage") is not None else None
        })
