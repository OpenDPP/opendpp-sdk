...
class RestoreOperatorResponse(BaseModel):
    """
    Outcome of restoring an archived economic operator, including how many of its passports were restored.
    """ # noqa: E501
    success: StrictBool
    restored_passports: Annotated[int, Field(strict=True, ge=0)] = Field(description="Number of archived passports returned to the active catalogue (`archivedAt` and `retentionUntil` cleared). Passports independently DECOMMISSIONED are not restored and not counted.", alias="restoredPassports")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["success", "restoredPassports"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RestoreOperatorResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RestoreOperatorResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "restoredPassports": obj.get("restoredPassports")
        })
