...
class DecodeGs1200Response(BaseModel):
    """
    DecodeGs1200Response
    """ # noqa: E501
    success: StrictBool
    input: StrictStr = Field(description="Which input form was decoded: `scanData`, `elementString` or `digitalLink`.")
    element_string: Optional[StrictStr] = Field(description="Bracketed AI element string, e.g. `(01)09501101532007(21)VM-1`.", alias="elementString")
    hri: List[StrictStr] = Field(description="Human-Readable Interpretation lines, e.g. `[\"(01) 09501101532007\", \"(21) VM-1\"]`.")
    canonical_upi: Optional[StrictStr] = Field(description="Host-independent canonical Digital Link (`https://id.gs1.org/…`).", alias="canonicalUpi")
    digital_link_uri: Optional[StrictStr] = Field(description="The canonical path rehosted on this node's resolver host — GET it to resolve.", alias="digitalLinkUri")
    ai: Dict[str, StrictStr] = Field(description="Application Identifier → value map, e.g. `{\"01\": \"09501101532007\", \"21\": \"VM-1\"}`.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["success", "input", "elementString", "hri", "canonicalUpi", "digitalLinkUri", "ai"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DecodeGs1200Response from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if element_string (nullable) is None
        # and model_fields_set contains the field
        if self.element_string is None and "element_string" in self.model_fields_set:
            _dict['elementString'] = None

        # set to None if canonical_upi (nullable) is None
        # and model_fields_set contains the field
        if self.canonical_upi is None and "canonical_upi" in self.model_fields_set:
            _dict['canonicalUpi'] = None

        # set to None if digital_link_uri (nullable) is None
        # and model_fields_set contains the field
        if self.digital_link_uri is None and "digital_link_uri" in self.model_fields_set:
            _dict['digitalLinkUri'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DecodeGs1200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "input": obj.get("input"),
            "elementString": obj.get("elementString"),
            "hri": obj.get("hri"),
            "canonicalUpi": obj.get("canonicalUpi"),
