...
class BatteryUnitDynamicDataEvent(BaseModel):
    """
    ...
    state_of_health: Optional[Union[StrictFloat, StrictInt]] = Field(alias="stateOfHealth")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BatteryUnitDynamicDataEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BatteryUnitDynamicDataEvent from a dict"""
        if obj is None:
            return None
