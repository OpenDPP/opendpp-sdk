...
class EconomicOperatorNode(BaseModel):
    ...
    id: StrictStr
    name: StrictStr
    reg_id: StrictStr = Field(description="EORI number or official business-registry identifier (unique platform-wide), e.g. `EU-DEFAULT-001`.", alias="regId")
    ...
    __properties: ClassVar[List[str]] = ["@type", "id", "name", "regId", "role"]
