...
class SealVerifyRequestPayloadProof(BaseModel):
    """
    ...
    proof_value: Optional[StrictStr] = Field(default=None, description="Base64 ECDSA seal — used as `signature` when the top-level field is absent.", alias="proofValue")
    signature_value: Optional[StrictStr] = Field(default=None, description="Legacy alias for `proofValue` (checked second).", alias="signatureValue")
    public_key_pem: Optional[StrictStr] = Field(default=None, description="PEM (SPKI) public key — used as `publicKey` when the top-level field is absent.", alias="publicKeyPem")
    x5c: Optional[List[StrictStr]] = Field(default=None, description="X.509 certificate chain, base64 DER, LEAF FIRST. Enables the `certificate` report; the leaf's SPKI also serves as the public key when none is otherwise supplied.")
    rfc3161: Optional[SealVerifyRequestPayloadProofRfc3161] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["type", "proofValue", "signatureValue", "publicKeyPem", "x5c", "rfc3161"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SealVerifyRequestPayloadProof from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SealVerifyRequestPayloadProof from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "x5c": obj.get("x5c"),
            "rfc3161": SealVerifyRequestPayloadProofRfc3161.from_dict(obj["rfc3161"]) if obj.get("rfc3161") is not None else None
        })
