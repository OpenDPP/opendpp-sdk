...
class DecodeGs1Batch200ResponseResultsInnerOneOf1(BaseModel):
    """
    DecodeGs1Batch200ResponseResultsInnerOneOf1
    """ # noqa: E501
    ok: StrictBool
    error: StrictStr
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DecodeGs1Batch200ResponseResultsInnerOneOf1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DecodeGs1Batch200ResponseResultsInnerOneOf1 from a dict"""
        if obj is None:
            return None
