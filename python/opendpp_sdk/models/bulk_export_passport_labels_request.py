...
class BulkExportPassportLabelsRequest(BaseModel):
    ...
    hri: Optional[StrictBool] = Field(default=False, description="Overlay the GS1 Human-Readable Interpretation beneath each symbol. Requires `format: \"svg\"`.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["ids", "format", "size", "ecl", "hri"]
