...
class DecodeGs1Request(BaseModel):
    """
    Provide exactly one of the three input forms.
    """ # noqa: E501
    scan_data: Optional[Annotated[str, Field(strict=True, max_length=4096)]] = Field(default=None, description="Raw scanner output including its AIM symbology identifier prefix (e.g. `]Q1…` QR, `]d2…` DataMatrix, `]C1…` GS1-128).", alias="scanData")
    element_string: Optional[Annotated[str, Field(strict=True, max_length=4096)]] = Field(default=None, description="Bracketed GS1 AI element string, e.g. `(01)09501101532007(21)VM-1`.", alias="elementString")
    digital_link: Optional[Annotated[str, Field(strict=True, max_length=4096)]] = Field(default=None, description="A GS1 Digital Link URI (http/https).", alias="digitalLink")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["scanData", "elementString", "digitalLink"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DecodeGs1Request from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DecodeGs1Request from a dict"""
        if obj is None:
            return None
