...
class WebhookSubscriptionUpdateRequest(BaseModel):
    ...
    """ # noqa: E501
    url: Optional[StrictStr] = Field(default=None, description="New receiver URL. Re-validated by the SSRF guard.")
    events: Optional[Annotated[List[WebhookEventFilter], Field(min_length=1)]] = Field(default=None, description="Replacement (non-empty) event-filter set.")
    is_active: Optional[StrictBool] = Field(default=None, description="Pause (`false`) or resume (`true`) deliveries.", alias="isActive")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["url", "events", "isActive"]
