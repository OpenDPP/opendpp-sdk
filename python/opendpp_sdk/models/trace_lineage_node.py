...
class TraceLineageNode(BaseModel):
    """
    ...
    biz_step: StrictStr = Field(alias="bizStep")
    disposition: StrictStr
    event_time: datetime = Field(alias="eventTime")
    epcs: List[StrictStr] = Field(description="EPC URIs parsed from the stored EPC list (degrades to `[]` when unparseable).")
    location: Optional[StrictStr] = Field(description="The event's stored `bizLocation`.")
    read_point: Optional[StrictStr] = Field(alias="readPoint")
    is_untp_compliant: StrictBool = Field(alias="isUntpCompliant")
    issuer_did: Optional[StrictStr] = Field(alias="issuerDid")
    parents: List[TraceLineageNode] = Field(description="Upstream parent events (recursive). Empty array at the origin of the chain.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["eventId", "eventType", "bizStep", "disposition", "eventTime", "epcs", "location", "readPoint", "isUntpCompliant", "issuerDid", "parents"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TraceLineageNode from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if read_point (nullable) is None
        # and model_fields_set contains the field
        if self.read_point is None and "read_point" in self.model_fields_set:
            _dict['readPoint'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TraceLineageNode from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "bizStep": obj.get("bizStep"),
            "disposition": obj.get("disposition"),
            "eventTime": obj.get("eventTime"),
            "epcs": obj.get("epcs"),
            "location": obj.get("location"),
            "readPoint": obj.get("readPoint"),
            "isUntpCompliant": obj.get("isUntpCompliant"),
            "issuerDid": obj.get("issuerDid"),
            "parents": [TraceLineageNode.from_dict(_item) for _item in obj["parents"]] if obj.get("parents") is not None else None
        })
...
TraceLineageNode.model_rebuild(raise_errors=False)
