...
class DeleteDraftPassport200Response(BaseModel):
    """
    ...
    def message_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Draft passport deleted.']):
            raise ValueError("must be one of enum values ('Draft passport deleted.')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeleteDraftPassport200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeleteDraftPassport200Response from a dict"""
        if obj is None:
            return None
