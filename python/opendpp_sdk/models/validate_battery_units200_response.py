...
class ValidateBatteryUnits200Response(BaseModel):
    """
    ValidateBatteryUnits200Response
    """ # noqa: E501
    success: StrictBool
    message: Optional[StrictStr] = None
    count: StrictInt = Field(description="Number of units checked.")
    valid_count: StrictInt = Field(description="How many are GS1-conformant.", alias="validCount")
    results: List[ValidateBatteryUnits200ResponseResultsInner]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["success", "message", "count", "validCount", "results"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ValidateBatteryUnits200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ValidateBatteryUnits200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "results": [ValidateBatteryUnits200ResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
