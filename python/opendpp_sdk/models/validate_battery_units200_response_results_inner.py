...
class ValidateBatteryUnits200ResponseResultsInner(BaseModel):
    """
    ValidateBatteryUnits200ResponseResultsInner
    """ # noqa: E501
    serial_number: Optional[StrictStr] = Field(alias="serialNumber")
    ok: StrictBool
    error: Optional[StrictStr] = Field(default=None, description="Present only when ok=false.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["serialNumber", "ok", "error"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ValidateBatteryUnits200ResponseResultsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ValidateBatteryUnits200ResponseResultsInner from a dict"""
        if obj is None:
            return None
