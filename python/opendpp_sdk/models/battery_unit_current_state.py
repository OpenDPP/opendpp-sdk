...
class BatteryUnitCurrentState(BaseModel):
    """
    ...
    """ # noqa: E501
    state_of_health: Optional[Union[StrictFloat, StrictInt]] = Field(description="State of health, percent (0-100).", alias="stateOfHealth")
    cycle_count: Optional[StrictInt] = Field(description="Cumulative full-equivalent charge cycles.", alias="cycleCount")
    remaining_capacity_ah: Optional[Union[StrictFloat, StrictInt]] = Field(description="Measured remaining capacity in ampere-hours.", alias="remainingCapacityAh")
    temperature_c: Optional[Union[StrictFloat, StrictInt]] = Field(description="Observed temperature in degrees Celsius.", alias="temperatureC")
    recorded_at: datetime = Field(description="When the measurement was taken (client-supplied).", alias="recordedAt")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["stateOfHealth", "cycleCount", "remainingCapacityAh", "temperatureC", "recordedAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BatteryUnitCurrentState from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BatteryUnitCurrentState from a dict"""
        if obj is None:
            return None
