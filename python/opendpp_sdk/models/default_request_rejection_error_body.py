...
class DefaultRequestRejectionErrorBody(BaseModel):
    """
    DefaultRequestRejectionErrorBody
    """ # noqa: E501
    status_code: StrictInt = Field(alias="statusCode")
    code: Optional[StrictStr] = Field(default=None, description="Machine-readable error code; present for envelope (schema) violations (`FST_ERR_VALIDATION`), may be absent for malformed JSON.")
    error: StrictStr
    message: StrictStr
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DefaultRequestRejectionErrorBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DefaultRequestRejectionErrorBody from a dict"""
        if obj is None:
            return None
