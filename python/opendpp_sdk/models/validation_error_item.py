...
class ValidationErrorItem(BaseModel):
    ...
    """ # noqa: E501
    path: StrictStr = Field(description="Dot/bracket path of the offending metadata field.")
    message: StrictStr = Field(description="Technical validation message.")
    friendly_message: Optional[StrictStr] = Field(default=None, description="Localized, human-friendly explanation (language from `?lang=` or `Accept-Language`; 28 languages, default `en`).", alias="friendlyMessage")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["path", "message", "friendlyMessage"]
