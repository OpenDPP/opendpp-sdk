...
class FacilityListEnvelope(BaseModel):
    ...
    facilities: List[FacilityRow] = Field(description="All facilities in the workspace, sorted by createdAt descending. Operator-scoped keys see only their operator's facilities.")
    ...
    __properties: ClassVar[List[str]] = ["success", "count", "facilities", "page", "limit", "total", "totalPages"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FacilityListEnvelope from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FacilityListEnvelope from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "count": obj.get("count"),
            "facilities": [FacilityRow.from_dict(_item) for _item in obj["facilities"]] if obj.get("facilities") is not None else None,
            "page": obj.get("page"),
            "limit": obj.get("limit"),
            "total": obj.get("total"),
