...
class PassportSealResponse(BaseModel):
    ...
    signing_public_key: StrictStr = Field(description="PEM-encoded public key of the tenant's signing key pair; verify the seal offline against `proof.merkleRoot`.", alias="signingPublicKey")
