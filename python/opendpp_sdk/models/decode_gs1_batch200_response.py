...
class DecodeGs1Batch200Response(BaseModel):
    """
    DecodeGs1Batch200Response
    """ # noqa: E501
    success: StrictBool
    count: StrictInt = Field(description="Number of items decoded (== items.length).")
    results: List[DecodeGs1Batch200ResponseResultsInner] = Field(description="One entry per input item, in order.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["success", "count", "results"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DecodeGs1Batch200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DecodeGs1Batch200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "count": obj.get("count"),
            "results": [DecodeGs1Batch200ResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
