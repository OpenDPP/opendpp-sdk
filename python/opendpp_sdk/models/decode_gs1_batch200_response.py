...
class DecodeGs1Batch200Response(BaseModel):
    ...
    results: List[Gs1BatchDecodeResult] = Field(description="One entry per input item, in order.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "count": obj.get("count"),
            "results": [Gs1BatchDecodeResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
