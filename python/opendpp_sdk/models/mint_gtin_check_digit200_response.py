...
class MintGtinCheckDigit200Response(BaseModel):
    """
    MintGtinCheckDigit200Response
    """ # noqa: E501
    success: StrictBool
    gtin: StrictStr = Field(description="The 14-digit GTIN (`prefix + itemRef + check digit`).")
    gs1_company_prefix: StrictStr = Field(alias="gs1CompanyPrefix")
    item_ref: StrictStr = Field(alias="itemRef")
    check_digit: StrictStr = Field(description="The computed GS1 mod-10 check digit (the 14th digit).", alias="checkDigit")
    digital_link: StrictStr = Field(description="A Digital Link preview `https://opendpp-node.eu/01/{gtin}` — resolvable once a passport uses this GTIN as its `productId`.", alias="digitalLink")
    note: StrictStr = Field(description="The ownership caveat: OpenDPP computes only the check digit and never allocates a prefix or asserts ownership.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["success", "gtin", "gs1CompanyPrefix", "itemRef", "checkDigit", "digitalLink", "note"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MintGtinCheckDigit200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MintGtinCheckDigit200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "gtin": obj.get("gtin"),
            "gs1CompanyPrefix": obj.get("gs1CompanyPrefix"),
            "itemRef": obj.get("itemRef"),
