...
class TraceEventRegistered(BaseModel):
    """
    201 envelope of POST /api/v1/events. Note: `status: \"success\"` (string), not the usual `success: true` boolean.
    """ # noqa: E501
    status: StrictStr
    event_id: StrictStr = Field(description="Server-generated event id. Use it with `GET /api/v1/events/{id}/lineage`.", alias="eventId")
    untp_verified: StrictBool = Field(alias="untpVerified")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["status", "eventId", "untpVerified"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TraceEventRegistered from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TraceEventRegistered from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "untpVerified": obj.get("untpVerified")
        })
