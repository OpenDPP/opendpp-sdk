...
class MerkleTreeAttestationProofRfc3161(BaseModel):
    """
    ...
    """ # noqa: E501
    gen_time: Optional[datetime] = Field(description="TSA generation time.", alias="genTime")
    token: StrictStr = Field(description="Base64 DER RFC 3161 TimeStampToken; verifies offline via `openssl ts -verify`.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["genTime", "token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MerkleTreeAttestationProofRfc3161 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MerkleTreeAttestationProofRfc3161 from a dict"""
        if obj is None:
            return None
