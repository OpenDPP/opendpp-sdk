...
class BulkBatteryUnitEventsRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    events: Annotated[List[BulkBatteryUnitEventsRequestEventsInner], Field(min_length=1, max_length=500)]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BulkBatteryUnitEventsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BulkBatteryUnitEventsRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "events": [BulkBatteryUnitEventsRequestEventsInner.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None
        })
