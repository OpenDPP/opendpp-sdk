...
class FacilityCreatedEnvelope(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["success", "message", "facility"]

    @field_validator('message')
    def message_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Facility registered successfully']):
            raise ValueError("must be one of enum values ('Facility registered successfully')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FacilityCreatedEnvelope from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FacilityCreatedEnvelope from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "facility": FacilityRow.from_dict(obj["facility"]) if obj.get("facility") is not None else None
        })
