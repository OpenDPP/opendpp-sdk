...
class EpcisDocument(BaseModel):
    ...
    epcis_body: EpcisDocumentEpcisBody = Field(alias="epcisBody")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["@context", "type", "schemaVersion", "creationDate", "epcisBody"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['EPCISDocument']):
            raise ValueError("must be one of enum values ('EPCISDocument')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EpcisDocument from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of epcis_body
        if self.epcis_body:
            _dict['epcisBody'] = self.epcis_body.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EpcisDocument from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "epcisBody": EpcisDocumentEpcisBody.from_dict(obj["epcisBody"]) if obj.get("epcisBody") is not None else None
        })
