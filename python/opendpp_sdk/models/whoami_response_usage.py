...
class WhoamiResponseUsage(BaseModel):
    """
    WhoamiResponseUsage
    """ # noqa: E501
    active_passports: StrictInt = Field(description="Active (non-draft, non-archived) passports counted against the quota — operator-scoped for a scoped key.", alias="activePassports")
    passport_limit: Optional[StrictInt] = Field(description="Tier passport quota, or `null` for an unlimited tier.", alias="passportLimit")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["activePassports", "passportLimit"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WhoamiResponseUsage from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if passport_limit (nullable) is None
        # and model_fields_set contains the field
        if self.passport_limit is None and "passport_limit" in self.model_fields_set:
            _dict['passportLimit'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WhoamiResponseUsage from a dict"""
        if obj is None:
            return None
