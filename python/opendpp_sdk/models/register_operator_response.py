...
class RegisterOperatorResponse(BaseModel):
    ...
    warnings: List[AdvisoryItem] = Field(description="Non-blocking advisories. Carries a single EORI-not-found note when the OPT-IN EORI existence check is enabled and a declared EORI is not found in the EU EOS register. Empty `[]` otherwise. Never blocks registration.")
