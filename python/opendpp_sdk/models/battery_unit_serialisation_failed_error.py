...
class BatteryUnitSerialisationFailedError(BaseModel):
    """
    ...
    success: StrictBool
    error: StrictStr
    errors: Annotated[List[StrictStr], Field(min_length=1)]
    ...
    def error_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Serialisation Failed']):
            raise ValueError("must be one of enum values ('Serialisation Failed')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BatteryUnitSerialisationFailedError from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BatteryUnitSerialisationFailedError from a dict"""
        if obj is None:
            return None
