...
class MintGtinCheckDigitRequest(BaseModel):
    """
    MintGtinCheckDigitRequest
    """ # noqa: E501
    gs1_company_prefix: StrictStr = Field(description="The GS1 company prefix your organisation legally owns (digits only, typically 7-10 digits).", alias="gs1CompanyPrefix")
    item_ref: Optional[StrictStr] = Field(default=None, description="The item reference (digits only) that, appended to the prefix, makes exactly 13 digits.", alias="itemRef")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["gs1CompanyPrefix", "itemRef"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MintGtinCheckDigitRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MintGtinCheckDigitRequest from a dict"""
        if obj is None:
            return None
