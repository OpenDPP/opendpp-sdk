...
class UntpEventCredentialSubjectOriginLocation(BaseModel):
    """
    ...
    eudr_plot_id: Optional[StrictStr] = Field(default=None, alias="eudrPlotId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["latitude", "longitude", "eudrPlotId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UntpEventCredentialSubjectOriginLocation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UntpEventCredentialSubjectOriginLocation from a dict"""
        if obj is None:
            return None
