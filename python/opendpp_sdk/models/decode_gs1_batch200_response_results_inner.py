...
DECODEGS1BATCH200RESPONSERESULTSINNER_ONE_OF_SCHEMAS = ["DecodeGs1Batch200ResponseResultsInnerOneOf", "DecodeGs1Batch200ResponseResultsInnerOneOf1"]

class DecodeGs1Batch200ResponseResultsInner(BaseModel):
    """
    DecodeGs1Batch200ResponseResultsInner
    """
    # data type: DecodeGs1Batch200ResponseResultsInnerOneOf
    oneof_schema_1_validator: Optional[DecodeGs1Batch200ResponseResultsInnerOneOf] = None
    # data type: DecodeGs1Batch200ResponseResultsInnerOneOf1
    oneof_schema_2_validator: Optional[DecodeGs1Batch200ResponseResultsInnerOneOf1] = None
    actual_instance: Optional[Union[DecodeGs1Batch200ResponseResultsInnerOneOf, DecodeGs1Batch200ResponseResultsInnerOneOf1]] = None
    one_of_schemas: Set[str] = { "DecodeGs1Batch200ResponseResultsInnerOneOf", "DecodeGs1Batch200ResponseResultsInnerOneOf1" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = DecodeGs1Batch200ResponseResultsInner.model_construct()
        error_messages = []
        match = 0
        # validate data type: DecodeGs1Batch200ResponseResultsInnerOneOf
        if not isinstance(v, DecodeGs1Batch200ResponseResultsInnerOneOf):
            error_messages.append(f"Error! Input type `{type(v)}` is not `DecodeGs1Batch200ResponseResultsInnerOneOf`")
        else:
            match += 1
        # validate data type: DecodeGs1Batch200ResponseResultsInnerOneOf1
        if not isinstance(v, DecodeGs1Batch200ResponseResultsInnerOneOf1):
            error_messages.append(f"Error! Input type `{type(v)}` is not `DecodeGs1Batch200ResponseResultsInnerOneOf1`")
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in DecodeGs1Batch200ResponseResultsInner with oneOf schemas: DecodeGs1Batch200ResponseResultsInnerOneOf, DecodeGs1Batch200ResponseResultsInnerOneOf1. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in DecodeGs1Batch200ResponseResultsInner with oneOf schemas: DecodeGs1Batch200ResponseResultsInnerOneOf, DecodeGs1Batch200ResponseResultsInnerOneOf1. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into DecodeGs1Batch200ResponseResultsInnerOneOf
        try:
            instance.actual_instance = DecodeGs1Batch200ResponseResultsInnerOneOf.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into DecodeGs1Batch200ResponseResultsInnerOneOf1
        try:
            instance.actual_instance = DecodeGs1Batch200ResponseResultsInnerOneOf1.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into DecodeGs1Batch200ResponseResultsInner with oneOf schemas: DecodeGs1Batch200ResponseResultsInnerOneOf, DecodeGs1Batch200ResponseResultsInnerOneOf1. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into DecodeGs1Batch200ResponseResultsInner with oneOf schemas: DecodeGs1Batch200ResponseResultsInnerOneOf, DecodeGs1Batch200ResponseResultsInnerOneOf1. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], DecodeGs1Batch200ResponseResultsInnerOneOf, DecodeGs1Batch200ResponseResultsInnerOneOf1]]:
