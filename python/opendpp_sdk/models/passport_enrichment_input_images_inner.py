...
class PassportEnrichmentInputImagesInner(BaseModel):
    """
    PassportEnrichmentInputImagesInner
    """ # noqa: E501
    url: Optional[StrictStr] = Field(default=None, description="http, https, or mailto only.")
    caption: Optional[StrictStr] = Field(default=None, description="Server-capped at 200 chars.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["url", "caption"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PassportEnrichmentInputImagesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PassportEnrichmentInputImagesInner from a dict"""
        if obj is None:
            return None
