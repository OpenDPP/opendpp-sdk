...
class PassportUpdateValidationError(BaseModel):
    """
    ...
    error: StrictStr
    message: StrictStr
    errors: List[ValidationErrorItem] = Field(description="Blocking validation errors. `friendlyMessage` is localized via the `lang` query parameter / Accept-Language (default en).")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["success", "error", "message", "errors"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PassportUpdateValidationError from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PassportUpdateValidationError from a dict"""
        if obj is None:
            return None
