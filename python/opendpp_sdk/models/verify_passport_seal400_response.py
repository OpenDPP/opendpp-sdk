...
class VerifyPassportSeal400Response(BaseModel):
    """
    ...
    def message_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Missing cryptographic parameter: payload, signature, and publicKey are required', 'Signature verification failed.']):
            raise ValueError("must be one of enum values ('Missing cryptographic parameter: payload, signature, and publicKey are required', 'Signature verification failed.')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VerifyPassportSeal400Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VerifyPassportSeal400Response from a dict"""
        if obj is None:
            return None
