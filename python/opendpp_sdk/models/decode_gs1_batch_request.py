...
class DecodeGs1BatchRequest(BaseModel):
    """
    DecodeGs1BatchRequest
    """ # noqa: E501
    items: Annotated[List[DecodeGs1BatchRequestItemsInner], Field(min_length=1, max_length=200)] = Field(description="Up to 200 scans, each an object with exactly one of scanData/elementString/digitalLink.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DecodeGs1BatchRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DecodeGs1BatchRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "items": [DecodeGs1BatchRequestItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
