...
class WebhookSubscriptionRow(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "tenantId", "url", "events", "isActive", "createdAt", "updatedAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebhookSubscriptionRow from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebhookSubscriptionRow from a dict"""
        if obj is None:
            return None
