...
class PassportVcReadinessReport200ResponseResultsInner(BaseModel):
    """
    PassportVcReadinessReport200ResponseResultsInner
    """ # noqa: E501
    id: StrictStr = Field(description="The passport UUID.")
    product_id: StrictStr = Field(alias="productId")
    vc_ready: StrictBool = Field(alias="vcReady")
    blockers: List[StrictStr] = Field(description="Actionable reasons this SKU can't emit a VC (same text as the single-passport signal); empty when `vcReady` is true.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "productId", "vcReady", "blockers"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PassportVcReadinessReport200ResponseResultsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PassportVcReadinessReport200ResponseResultsInner from a dict"""
        if obj is None:
            return None
