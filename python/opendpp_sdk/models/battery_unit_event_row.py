...
class BatteryUnitEventRow(BaseModel):
    """
    ...
    """ # noqa: E501
    id: StrictStr
    battery_unit_id: StrictStr = Field(alias="batteryUnitId")
    tenant_id: StrictStr = Field(alias="tenantId")
    event_type: BatteryUnitEventType = Field(alias="eventType")
    state_of_health: Optional[Union[Annotated[float, Field(le=100, strict=True, ge=0)], Annotated[int, Field(le=100, strict=True, ge=0)]]] = Field(description="State of health, percent.", alias="stateOfHealth")
    cycle_count: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(description="Cumulative full-equivalent cycles (truncated to an integer on write).", alias="cycleCount")
    remaining_capacity_ah: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = Field(description="Measured remaining capacity, ampere-hours.", alias="remainingCapacityAh")
    temperature_c: Optional[Union[Annotated[float, Field(le=10000, strict=True, ge=-273.15)], Annotated[int, Field(le=10000, strict=True, ge=-273)]]] = Field(description="Observed temperature, °C.", alias="temperatureC")
    payload: Optional[Any]
    recorded_at: datetime = Field(description="When the measurement was taken (client-supplied; server time when omitted).", alias="recordedAt")
    created_at: datetime = Field(description="Immutable append timestamp (server-assigned).", alias="createdAt")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "batteryUnitId", "tenantId", "eventType", "stateOfHealth", "cycleCount", "remainingCapacityAh", "temperatureC", "payload", "recordedAt", "createdAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BatteryUnitEventRow from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BatteryUnitEventRow from a dict"""
        if obj is None:
            return None
