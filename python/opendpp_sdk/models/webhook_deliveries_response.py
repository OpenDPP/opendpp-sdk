...
class WebhookDeliveriesResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["success", "count", "deliveries"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "count": obj.get("count"),
            "deliveries": [WebhookDeliveryRow.from_dict(_item) for _item in obj["deliveries"]] if obj.get("deliveries") is not None else None
        })
