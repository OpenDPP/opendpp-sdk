...
class OperatorListResponse(BaseModel):
    ...
    """ # noqa: E501
    success: StrictBool
    count: StrictInt = Field(description="Number of operators returned (the list is not paginated).")
    operators: List[OperatorRow]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["success", "count", "operators"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        _items = []
        if self.operators:
            for _item_operators in self.operators:
                if _item_operators:
                    _items.append(_item_operators.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "count": obj.get("count"),
            "operators": [OperatorRow.from_dict(_item) for _item in obj["operators"]] if obj.get("operators") is not None else None
        })
