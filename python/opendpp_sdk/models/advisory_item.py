...
class AdvisoryItem(BaseModel):
    ...
    def code_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NON_GS1_PRODUCT_ID', 'PII_SHAPE_DETECTED', 'UNIT_NO_SCANNABLE_LINK', 'DRAFT_DEMOTED', 'EORI_NOT_FOUND', 'OPERATOR_AUTO_ATTRIBUTED', 'GTIN_AUTO_COPIED']):
            raise ValueError("must be one of enum values ('NON_GS1_PRODUCT_ID', 'PII_SHAPE_DETECTED', 'UNIT_NO_SCANNABLE_LINK', 'DRAFT_DEMOTED', 'EORI_NOT_FOUND', 'OPERATOR_AUTO_ATTRIBUTED', 'GTIN_AUTO_COPIED')")
        return value
