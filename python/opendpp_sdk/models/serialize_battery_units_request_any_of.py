...
class SerializeBatteryUnitsRequestAnyOf(BaseModel):
    """
    SerializeBatteryUnitsRequestAnyOf
    """ # noqa: E501
    units: Annotated[List[BatteryUnitCreateItem], Field(min_length=1, max_length=200)] = Field(description="1–200 units per request. An empty array is rejected with 400 `Bad Request`; more than 200 likewise.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SerializeBatteryUnitsRequestAnyOf from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SerializeBatteryUnitsRequestAnyOf from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "units": [BatteryUnitCreateItem.from_dict(_item) for _item in obj["units"]] if obj.get("units") is not None else None
        })
