...
class DecodeGs1Batch200ResponseResultsInnerOneOf(BaseModel):
    """
    DecodeGs1Batch200ResponseResultsInnerOneOf
    """ # noqa: E501
    ok: StrictBool
    input: StrictStr
    element_string: Optional[StrictStr] = Field(alias="elementString")
    hri: List[StrictStr]
    canonical_upi: Optional[StrictStr] = Field(alias="canonicalUpi")
    digital_link_uri: Optional[StrictStr] = Field(alias="digitalLinkUri")
    ai: Dict[str, StrictStr]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["ok", "input", "elementString", "hri", "canonicalUpi", "digitalLinkUri", "ai"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DecodeGs1Batch200ResponseResultsInnerOneOf from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DecodeGs1Batch200ResponseResultsInnerOneOf from a dict"""
        if obj is None:
            return None
