...
class SealVerifyRequestPayloadProofRfc3161(BaseModel):
    """
    SealVerifyRequestPayloadProofRfc3161
    """ # noqa: E501
    token: Optional[StrictStr] = Field(default=None, description="RFC 3161 TimeStampToken (base64 DER CMS ContentInfo) — enables the `timestamp` report.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SealVerifyRequestPayloadProofRfc3161 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SealVerifyRequestPayloadProofRfc3161 from a dict"""
        if obj is None:
            return None
