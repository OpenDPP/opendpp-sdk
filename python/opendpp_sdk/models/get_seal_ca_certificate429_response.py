...
class GetSealCaCertificate429Response(BaseModel):
    """
    ...
    def error_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Too Many Requests']):
            raise ValueError("must be one of enum values ('Too Many Requests')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetSealCaCertificate429Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetSealCaCertificate429Response from a dict"""
        if obj is None:
            return None
