...
class UpdateOperatorRequest(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="New display name (trimmed).")
    role: Optional[StrictStr] = Field(default=None, description="New supply-chain role, free text (trimmed) — e.g. `MANUFACTURER`, `IMPORTER`, `RETAILER`.")
    eori: Optional[StrictStr] = Field(default=None, description="The EU EORI to set, or `null` to clear it.")
    reg_id_scheme: Optional[StrictStr] = Field(default=None, description="Only for an `UNDECLARED` operator: the clause 6 scheme being declared, together with `regId`.", alias="regIdScheme")
    reg_id: Optional[StrictStr] = Field(default=None, description="Only for an `UNDECLARED` operator: the identifier under the scheme being declared.", alias="regId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "role", "eori", "regIdScheme", "regId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateOperatorRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateOperatorRequest from a dict"""
        if obj is None:
            return None
