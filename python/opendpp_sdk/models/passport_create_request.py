...
class PassportCreateRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["productId", "operatorId", "facilityId", "metadata", "draft", "enrichment"]
