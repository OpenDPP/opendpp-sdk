...
class GrantRouteError(BaseModel):
    """
    ...
    """ # noqa: E501
    error: StrictStr = Field(description="HTTP reason phrase, e.g. `Bad Request`, `Not Found`, `Conflict`, `Forbidden`.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GrantRouteError from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GrantRouteError from a dict"""
        if obj is None:
            return None
