...
class PassportQuotaErrorQuota(BaseModel):
    """
    Present only on a `passport_quota_exceeded` block: current usage vs the tier cap.
    """ # noqa: E501
    tier: Optional[StrictStr] = Field(default=None, description="The workspace subscription tier.")
    active_passports: Optional[StrictInt] = Field(default=None, description="Active (non-draft, non-archived) passports, counted tenant-wide.", alias="activePassports")
    passport_limit: Optional[StrictInt] = Field(default=None, description="The tier's passport cap.", alias="passportLimit")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["tier", "activePassports", "passportLimit"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PassportQuotaErrorQuota from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PassportQuotaErrorQuota from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "tier": obj.get("tier"),
            "activePassports": obj.get("activePassports"),
            "passportLimit": obj.get("passportLimit")
        })
