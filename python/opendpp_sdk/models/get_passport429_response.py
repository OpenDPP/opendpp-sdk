...
GETPASSPORT429RESPONSE_ANY_OF_SCHEMAS = ["GetPassport429ResponseAnyOf", "GetPassport429ResponseAnyOf1"]

class GetPassport429Response(BaseModel):
    """
    GetPassport429Response
    """

    # data type: GetPassport429ResponseAnyOf
    anyof_schema_1_validator: Optional[GetPassport429ResponseAnyOf] = None
    # data type: GetPassport429ResponseAnyOf1
    anyof_schema_2_validator: Optional[GetPassport429ResponseAnyOf1] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[GetPassport429ResponseAnyOf, GetPassport429ResponseAnyOf1]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "GetPassport429ResponseAnyOf", "GetPassport429ResponseAnyOf1" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = GetPassport429Response.model_construct()
        error_messages = []
        # validate data type: GetPassport429ResponseAnyOf
        if not isinstance(v, GetPassport429ResponseAnyOf):
            error_messages.append(f"Error! Input type `{type(v)}` is not `GetPassport429ResponseAnyOf`")
        else:
            return v

        # validate data type: GetPassport429ResponseAnyOf1
        if not isinstance(v, GetPassport429ResponseAnyOf1):
            error_messages.append(f"Error! Input type `{type(v)}` is not `GetPassport429ResponseAnyOf1`")
        else:
            return v

        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in GetPassport429Response with anyOf schemas: GetPassport429ResponseAnyOf, GetPassport429ResponseAnyOf1. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_1_validator: Optional[GetPassport429ResponseAnyOf] = None
        try:
            instance.actual_instance = GetPassport429ResponseAnyOf.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_2_validator: Optional[GetPassport429ResponseAnyOf1] = None
        try:
            instance.actual_instance = GetPassport429ResponseAnyOf1.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into GetPassport429Response with anyOf schemas: GetPassport429ResponseAnyOf, GetPassport429ResponseAnyOf1. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], GetPassport429ResponseAnyOf, GetPassport429ResponseAnyOf1]]:
