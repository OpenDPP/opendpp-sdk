...
class EpcisCaptureResponseResultsInner(BaseModel):
    """
    EpcisCaptureResponseResultsInner
    """ # noqa: E501
    index: StrictInt = Field(description="Position of the event in the submitted eventList.")
    event_id: StrictStr = Field(description="Server-generated row id (UUID) — the authoritative event identity on this node.", alias="eventId")
    event_type: StrictStr = Field(alias="eventType")
    ignored_fields: Optional[List[StrictStr]] = Field(default=None, description="Recognized EPCIS fields present on the event that this node does not persist — disclosed, never silently dropped.", alias="ignoredFields")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["index", "eventId", "eventType", "ignoredFields"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EpcisCaptureResponseResultsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EpcisCaptureResponseResultsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "ignoredFields": obj.get("ignoredFields")
        })
