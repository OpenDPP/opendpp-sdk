...
class DeleteOperatorResponse(BaseModel):
    ...
    """ # noqa: E501
    success: StrictBool
    archived: StrictBool = Field(description="`true` = the operator was archived (soft-deleted; passports retained, restorable). `false` = the operator was hard-deleted (it had no passports).")
    archived_passports: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Number of active passports archived alongside the operator. Present only on the primary archive path (operator had passports); absent on hard deletes and on the foreign-key fallback archive.", alias="archivedPassports")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["success", "archived", "archivedPassports"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "archivedPassports": obj.get("archivedPassports")
        })
