...
class AasEnvironmentInput(BaseModel):
    """
    ...
    """ # noqa: E501
    asset_administration_shells: Optional[List[Dict[str, Any]]] = Field(default=None, description="AAS shells. The first shell's `assetInformation.specificAssetIds` entry with `name: \"productId\"` is the last-resort productId source (after `metadata.gtin`/`metadata.grai`/`metadata.productId`).", alias="assetAdministrationShells")
    submodels: List[Dict[str, Any]] = Field(description="Must include the `ComplianceMetadata` submodel; may include `eidasVerificationSeal`.")
    concept_descriptions: Optional[List[Dict[str, Any]]] = Field(default=None, alias="conceptDescriptions")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AasEnvironmentInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AasEnvironmentInput from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "assetAdministrationShells": obj.get("assetAdministrationShells"),
            "submodels": obj.get("submodels"),
            "conceptDescriptions": obj.get("conceptDescriptions")
        })
