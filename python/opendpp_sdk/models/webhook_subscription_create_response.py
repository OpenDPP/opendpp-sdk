...
class WebhookSubscriptionCreateResponse(BaseModel):
    ...
    def message_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Webhook subscription registered successfully']):
            raise ValueError("must be one of enum values ('Webhook subscription registered successfully')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebhookSubscriptionCreateResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebhookSubscriptionCreateResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "subscription": WebhookSubscriptionWithSecret.from_dict(obj["subscription"]) if obj.get("subscription") is not None else None
        })
