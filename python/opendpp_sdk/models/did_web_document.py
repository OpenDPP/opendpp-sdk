...
class DidWebDocument(BaseModel):
    """
    ...
    id: StrictStr = Field(description="The workspace DID, `did:web:opendpp-node.eu:tenants:{tenantId}`.")
    name: Optional[StrictStr] = Field(default=None, description="The issuer's authoritative legal name (present when the workspace has a company name).")
    verification_method: List[DidWebDocumentVerificationMethodInner] = Field(description="Public verification keys.", alias="verificationMethod")
    assertion_method: List[StrictStr] = Field(description="Verification-method ids authorized to assert credentials (current + retired keys).", alias="assertionMethod")
    authentication: List[StrictStr]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["@context", "id", "name", "verificationMethod", "assertionMethod", "authentication"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DidWebDocument from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DidWebDocument from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "verificationMethod": [DidWebDocumentVerificationMethodInner.from_dict(_item) for _item in obj["verificationMethod"]] if obj.get("verificationMethod") is not None else None,
