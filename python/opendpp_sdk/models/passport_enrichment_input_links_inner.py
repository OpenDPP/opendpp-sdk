...
class PassportEnrichmentInputLinksInner(BaseModel):
    """
    PassportEnrichmentInputLinksInner
    """ # noqa: E501
    label: Optional[StrictStr] = Field(default=None, description="Server-capped at 120 chars.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PassportEnrichmentInputLinksInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PassportEnrichmentInputLinksInner from a dict"""
        if obj is None:
            return None
