...
class EpcisDocumentEpcisBody(BaseModel):
    """
    EpcisDocumentEpcisBody
    """ # noqa: E501
    event_list: List[Dict[str, Any]] = Field(alias="eventList")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["eventList"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EpcisDocumentEpcisBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EpcisDocumentEpcisBody from a dict"""
        if obj is None:
            return None
