...
class PassportAasEnvironment(BaseModel):
    """
    ...
    """ # noqa: E501
    asset_administration_shells: List[Dict[str, Any]] = Field(alias="assetAdministrationShells")
    submodels: List[Dict[str, Any]]
    concept_descriptions: List[Dict[str, Any]] = Field(alias="conceptDescriptions")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PassportAasEnvironment from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PassportAasEnvironment from a dict"""
        if obj is None:
            return None
