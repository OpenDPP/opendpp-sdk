...
class WhoamiResponse(BaseModel):
    ...
    """ # noqa: E501
    success: StrictBool
    tenant: WhoamiResponseTenant
    auth: WhoamiResponseAuth
    usage: WhoamiResponseUsage
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["success", "tenant", "auth", "usage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tenant": WhoamiResponseTenant.from_dict(obj["tenant"]) if obj.get("tenant") is not None else None,
            "auth": WhoamiResponseAuth.from_dict(obj["auth"]) if obj.get("auth") is not None else None,
            "usage": WhoamiResponseUsage.from_dict(obj["usage"]) if obj.get("usage") is not None else None
        })
