...
class Error(BaseModel):
    ...
    def code_validate_enum(cls, value):
        ...
        if value not in set(['OPERATOR_NOT_BOUND', 'OPERATOR_AMBIGUOUS', 'OPERATOR_SCOPE_FORBIDDEN', 'GTIN_CHECK_DIGIT_INVALID', 'GLN_CHECK_DIGIT_INVALID', 'UNSUPPORTED_KEY_QUALIFIER', 'UNSUPPORTED_REPRESENTATION', 'COMPRESSED_DIGITAL_LINK', 'PASSPORT_DUPLICATE', 'PASSPORT_SEALED_IMMUTABLE', 'CATEGORY_IMMUTABLE', 'DRAFT_DEMOTION_REFUSED', 'FACILITY_NOT_FOUND', 'FACILITY_DUPLICATE', 'WEBHOOK_NOT_FOUND', 'WEBHOOK_LIMIT_REACHED', 'WEBHOOK_URL_REJECTED']):
            raise ValueError("must be one of enum values ('OPERATOR_NOT_BOUND', 'OPERATOR_AMBIGUOUS', 'OPERATOR_SCOPE_FORBIDDEN', 'GTIN_CHECK_DIGIT_INVALID', 'GLN_CHECK_DIGIT_INVALID', 'UNSUPPORTED_KEY_QUALIFIER', 'UNSUPPORTED_REPRESENTATION', 'COMPRESSED_DIGITAL_LINK', 'PASSPORT_DUPLICATE', 'PASSPORT_SEALED_IMMUTABLE', 'CATEGORY_IMMUTABLE', 'DRAFT_DEMOTION_REFUSED', 'FACILITY_NOT_FOUND', 'FACILITY_DUPLICATE', 'WEBHOOK_NOT_FOUND', 'WEBHOOK_LIMIT_REACHED', 'WEBHOOK_URL_REJECTED')")
        return value
