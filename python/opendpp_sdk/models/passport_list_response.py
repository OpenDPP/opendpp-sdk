...
class PassportListResponse(BaseModel):
    ...
    page: Annotated[int, Field(strict=True, ge=1)] = Field(description="Effective page after server-side clamping (min 1).")
    limit: Annotated[int, Field(le=100, strict=True, ge=1)] = Field(description="Effective page size after server-side clamping (default 10, max 100).")
    passports: List[PassportListItem]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["success", "page", "limit", "passports"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PassportListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PassportListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "page": obj.get("page"),
            "limit": obj.get("limit"),
            "passports": [PassportListItem.from_dict(_item) for _item in obj["passports"]] if obj.get("passports") is not None else None
        })
