...
class WebhookSubscriptionDeleteResponse(BaseModel):
    ...
    def message_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Webhook subscription successfully deleted']):
            raise ValueError("must be one of enum values ('Webhook subscription successfully deleted')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebhookSubscriptionDeleteResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebhookSubscriptionDeleteResponse from a dict"""
        if obj is None:
            return None
