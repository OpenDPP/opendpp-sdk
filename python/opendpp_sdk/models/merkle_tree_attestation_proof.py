...
class MerkleTreeAttestationProof(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["@type", "type", "signatureAlgorithm", "created", "proofPurpose", "verificationMethod", "signatureValue", "publicKeyPem", "x5c", "rfc3161", "merkleRoot", "sealedKeys", "redactedLeaves"]
