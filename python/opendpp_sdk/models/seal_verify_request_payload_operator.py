...
class SealVerifyRequestPayloadOperator(BaseModel):
    """
    Declared economic operator. A present `regId` triggers the fail-closed operator-binding gate.
    """ # noqa: E501
    name: Optional[StrictStr] = None
    reg_id: Optional[StrictStr] = Field(default=None, description="The operator's identifier as registered under its EN 18219 clause 6 scheme (e.g. the demo operator's VAT number `LT000000000001`). Must resolve to a registered Economic Operator bound to the signing tenant, or verification fails (`verified: false`).", alias="regId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "regId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SealVerifyRequestPayloadOperator from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SealVerifyRequestPayloadOperator from a dict"""
        if obj is None:
            return None
