...
class SealVerifyRequestPayloadOperator(BaseModel):
    ...
    reg_id: Optional[StrictStr] = Field(default=None, description="Operator registration id (e.g. EORI-style `EU-DEFAULT-001`). Must resolve to a registered Economic Operator bound to the signing tenant, or verification fails (`verified: false`).", alias="regId")
