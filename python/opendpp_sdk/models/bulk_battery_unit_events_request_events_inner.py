...
class BulkBatteryUnitEventsRequestEventsInner(BaseModel):
    """
    BulkBatteryUnitEventsRequestEventsInner
    """ # noqa: E501
    event_type: BatteryUnitEventType = Field(alias="eventType")
    state_of_health: Optional[Union[Annotated[float, Field(le=100, strict=True, ge=0)], Annotated[int, Field(le=100, strict=True, ge=0)]]] = Field(default=None, description="State of Health, %.", alias="stateOfHealth")
    cycle_count: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = Field(default=None, description="Cumulative full-equivalent cycles; truncated to an integer before persisting.", alias="cycleCount")
    remaining_capacity_ah: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = Field(default=None, description="Measured remaining capacity, Ah.", alias="remainingCapacityAh")
    ...
    recorded_at: Optional[datetime] = Field(default=None, description="When the measurement was taken; defaults to server time when omitted.", alias="recordedAt")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["eventType", "stateOfHealth", "cycleCount", "remainingCapacityAh", "temperatureC", "payload", "recordedAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BulkBatteryUnitEventsRequestEventsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BulkBatteryUnitEventsRequestEventsInner from a dict"""
        if obj is None:
            return None
