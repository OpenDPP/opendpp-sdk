...
class PassportListItem(BaseModel):
    ...
    proof: Optional[Dict[str, Any]] = Field(description="Always the empty object on sealed items — proof contents are stripped by the list serialization.")
    created_at: datetime = Field(alias="createdAt")
    updated_at: datetime = Field(alias="updatedAt")
    economic_operator: Optional[EconomicOperatorNode] = Field(alias="economicOperator")
    manufacturing_facility: Optional[Any] = Field(alias="manufacturingFacility")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "manufacturingFacility": obj.get("manufacturingFacility"),
