...
class WebhookSubscriptionListResponse(BaseModel):
    ...
    """ # noqa: E501
    success: StrictBool
    subscriptions: List[WebhookSubscriptionRow]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["success", "subscriptions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subscriptions": [WebhookSubscriptionRow.from_dict(_item) for _item in obj["subscriptions"]] if obj.get("subscriptions") is not None else None
        })
