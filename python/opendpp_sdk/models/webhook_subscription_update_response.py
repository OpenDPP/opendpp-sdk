...
class WebhookSubscriptionUpdateResponse(BaseModel):
    """
    The webhook subscription as stored after the update.
    """ # noqa: E501
    success: StrictBool
    message: Optional[StrictStr] = Field(default=None, description="Present when a change was applied (`\"Webhook subscription updated\"`); absent when the body had no recognized fields.")
    subscription: WebhookSubscriptionRow
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["success", "message", "subscription"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebhookSubscriptionUpdateResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebhookSubscriptionUpdateResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "subscription": WebhookSubscriptionRow.from_dict(obj["subscription"]) if obj.get("subscription") is not None else None
        })
