...
class En18223DataElement(BaseModel):
    """
    ...
    """ # noqa: E501
    element_id: StrictStr = Field(description="The relative identifier of the element within its location (Table 2) — the key the compressed form uses.", alias="elementId")
    object_type: StrictStr = Field(description="The concrete DataElement subclass (4.1.2.3).", alias="objectType")
    dictionary_reference: StrictStr = Field(description="The unique identifier of the element's definition — `https://opendpp-node.eu/ns/dpp#<path>`, resolvable at `GET /ns/dpp` (4.3).", alias="dictionaryReference")
    value_data_type: Optional[StrictStr] = Field(default=None, description="The XSD data type of the value (Table 7, e.g. `xsd:decimal`); present on single-valued elements and on lists whose items share one native type.", alias="valueDataType")
    value: Optional[Any] = None
    elements: Optional[List[En18223DataElement]] = Field(default=None, description="A collection's members.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["elementId", "objectType", "dictionaryReference", "valueDataType", "value", "elements"]

    @field_validator('object_type')
    def object_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['DataElementCollection', 'SingleValuedDataElement', 'MultiValuedDataElement', 'RelatedResource', 'MultiLanguageDataElement']):
            raise ValueError("must be one of enum values ('DataElementCollection', 'SingleValuedDataElement', 'MultiValuedDataElement', 'RelatedResource', 'MultiLanguageDataElement')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of En18223DataElement from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of En18223DataElement from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "dictionaryReference": obj.get("dictionaryReference"),
            "valueDataType": obj.get("valueDataType"),
            "value": obj.get("value"),
...
En18223DataElement.model_rebuild(raise_errors=False)
