...
class BatteryUnitRow(BaseModel):
    ...
    digital_link_uri: StrictStr = Field(description="Per-unit GS1 Digital Link: `{origin}/{01|8003}/{productId}/21/{serialNumber}` — AI `01` for GTIN (and non-GS1 SKUs), `8003` for GRAI. Unique platform-wide.", alias="digitalLinkUri")
