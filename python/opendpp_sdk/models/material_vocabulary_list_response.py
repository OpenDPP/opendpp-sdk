...
class MaterialVocabularyListResponse(BaseModel):
    """
    Envelope of `GET /api/v1/materials`. Caveat: unlike most authenticated endpoints there is NO `success` field.
    """ # noqa: E501
    materials: List[MaterialVocabularyRow] = Field(description="Active vocabulary entries, ordered by `kind` ascending then `name` ascending, capped at `limit` (max 1000).")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["materials"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MaterialVocabularyListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MaterialVocabularyListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "materials": [MaterialVocabularyRow.from_dict(_item) for _item in obj["materials"]] if obj.get("materials") is not None else None
        })
