...
class GrantListResponse(BaseModel):
    ...
    grants: Annotated[List[GrantRow], Field(max_length=200)] = Field(description="Grants for this page (≤ `limit`), ordered by `status` ascending then `createdAt` descending.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["success", "count", "page", "limit", "total", "totalPages", "grants"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GrantListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GrantListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "grants": [GrantRow.from_dict(_item) for _item in obj["grants"]] if obj.get("grants") is not None else None
        })
