...
class ApproveGrantRequest(BaseModel):
    ...
    """ # noqa: E501
    expires_at: datetime = Field(description="Required. Date parsing is lenient (some non-ISO values may be accepted) — ISO 8601 is strongly recommended. Must be in the future and at most 366 days from now. Replaces the request's provisional 90-day expiry.", alias="expiresAt")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["expiresAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApproveGrantRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApproveGrantRequest from a dict"""
        if obj is None:
            return None
