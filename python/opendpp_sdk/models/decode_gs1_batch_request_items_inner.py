...
class DecodeGs1BatchRequestItemsInner(BaseModel):
    """
    DecodeGs1BatchRequestItemsInner
    """ # noqa: E501
    scan_data: Optional[Annotated[str, Field(strict=True, max_length=4096)]] = Field(default=None, alias="scanData")
    element_string: Optional[Annotated[str, Field(strict=True, max_length=4096)]] = Field(default=None, alias="elementString")
    digital_link: Optional[Annotated[str, Field(strict=True, max_length=4096)]] = Field(default=None, alias="digitalLink")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DecodeGs1BatchRequestItemsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DecodeGs1BatchRequestItemsInner from a dict"""
        if obj is None:
            return None
