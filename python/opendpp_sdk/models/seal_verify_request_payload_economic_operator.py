...
class SealVerifyRequestPayloadEconomicOperator(BaseModel):
    """
    Alternative location for the declared operator id — `economicOperator.regId` is checked when `operator.regId` is absent.
    """ # noqa: E501
    reg_id: Optional[StrictStr] = Field(default=None, alias="regId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["regId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SealVerifyRequestPayloadEconomicOperator from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SealVerifyRequestPayloadEconomicOperator from a dict"""
        if obj is None:
            return None
