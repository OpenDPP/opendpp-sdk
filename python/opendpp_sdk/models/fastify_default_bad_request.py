...
class FastifyDefaultBadRequest(BaseModel):
    """
    ...
    code: Optional[StrictStr] = Field(default=None, description="Framework error code, e.g. `FST_ERR_CTP_INVALID_JSON_BODY`. May be absent.")
    error: StrictStr
    message: StrictStr
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FastifyDefaultBadRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FastifyDefaultBadRequest from a dict"""
        if obj is None:
            return None
