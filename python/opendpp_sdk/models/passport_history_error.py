...
class PassportHistoryError(BaseModel):
    """
    PassportHistoryError
    """ # noqa: E501
    success: StrictBool
    error: StrictStr = Field(description="Short error category.")
    message: StrictStr = Field(description="Human-readable detail.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PassportHistoryError from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PassportHistoryError from a dict"""
        if obj is None:
            return None
