...
class PassportEnrichmentInput(BaseModel):
    """
    ...
    """ # noqa: E501
    tagline: Optional[StrictStr] = Field(default=None, description="Short marketing tagline (server-capped at 200 chars).")
    description: Optional[StrictStr] = Field(default=None, description="Marketing description (server-capped at 4000 chars).")
    images: Optional[List[PassportEnrichmentInputImagesInner]] = Field(default=None, description="Up to 24 kept. Items without a valid http/https/mailto `url` are dropped.")
    links: Optional[List[PassportEnrichmentInputLinksInner]] = Field(default=None, description="Up to 24 kept. Items without a valid http/https/mailto `url` are dropped; a missing `label` defaults to the URL.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["tagline", "description", "images", "links"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PassportEnrichmentInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PassportEnrichmentInput from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "images": [PassportEnrichmentInputImagesInner.from_dict(_item) for _item in obj["images"]] if obj.get("images") is not None else None,
            "links": [PassportEnrichmentInputLinksInner.from_dict(_item) for _item in obj["links"]] if obj.get("links") is not None else None
        })
