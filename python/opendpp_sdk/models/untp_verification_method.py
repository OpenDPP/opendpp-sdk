...
class UntpVerificationMethod(BaseModel):
    """
    ...
    x5c: Optional[List[StrictStr]] = Field(default=None, description="X.509 certificate chain, base64 DER, leaf first.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "controller", "x5c"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UntpVerificationMethod from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UntpVerificationMethod from a dict"""
        if obj is None:
            return None
