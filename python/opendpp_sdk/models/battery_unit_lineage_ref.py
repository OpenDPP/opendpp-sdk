...
class BatteryUnitLineageRef(BaseModel):
    """
    Public lineage pointer between battery units.
    """ # noqa: E501
    unit_id: StrictStr = Field(alias="unitId")
    serial_number: StrictStr = Field(alias="serialNumber")
    digital_link_uri: StrictStr = Field(alias="digitalLinkUri")
    unit_url: StrictStr = Field(description="Relative public unit URL: `/unit/{unitId}`.", alias="unitUrl")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["unitId", "serialNumber", "digitalLinkUri", "unitUrl"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BatteryUnitLineageRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BatteryUnitLineageRef from a dict"""
        if obj is None:
            return None
