...
class PassportBulkRow(BaseModel):
    """
    ...
    """ # noqa: E501
    product_id: Optional[StrictStr] = Field(default=None, description="GTIN-14 / GRAI / free-form SKU in ISO/IEC 646 characters (required in practice; a row without it, or with characters outside 7-bit ASCII, is skipped with an error string).", alias="productId")
    operator_id: Optional[StrictStr] = Field(default=None, description="Optional EconomicOperator UUID bound to your workspace; defaults to the workspace's first bound operator. Operator-scoped API keys force their operator.", alias="operatorId")
    facility_id: Optional[StrictStr] = Field(default=None, description="Optional Facility UUID in your workspace; unknown ids skip the row.", alias="facilityId")
    metadata: Optional[PassportMetadataInput] = None
    carrier: Optional[CarrierDeclaration] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["productId", "operatorId", "facilityId", "metadata", "carrier"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PassportBulkRow from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PassportBulkRow from a dict"""
        if obj is None:
            return None
