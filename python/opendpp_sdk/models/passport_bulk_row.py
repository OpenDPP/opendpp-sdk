...
class PassportBulkRow(BaseModel):
    ...
    """ # noqa: E501
    product_id: Optional[StrictStr] = Field(default=None, description="GTIN-14 / GRAI / free-form SKU (required in practice; rows without it are skipped with an error string).", alias="productId")
    ...
    __properties: ClassVar[List[str]] = ["productId", "operatorId", "facilityId", "metadata"]
