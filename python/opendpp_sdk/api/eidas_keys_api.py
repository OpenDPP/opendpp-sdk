...
class EIDASKeysApi:
    ...
    def get_seal_ca_certificate(
        ...
        _param = self._get_seal_ca_certificate_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "str",
            '429': "GetSealCaCertificate429Response",
            '503': "Error",
        }
    ...
    @validate_call
    def get_seal_ca_certificate_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_seal_ca_certificate_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_seal_ca_certificate_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/.well-known/opendpp-seal-ca.pem',
    ...
    def rotate_tenant_keys(
        ...
        _param = self._rotate_tenant_keys_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def rotate_tenant_keys_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RotateTenantKeysResponse]:
        """Rotate the tenant's ECDSA signing key pair
    ...
    @validate_call
    def rotate_tenant_keys_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _rotate_tenant_keys_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/tenants/rotate-keys',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
