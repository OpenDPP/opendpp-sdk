...
class SchemasVocabularyApi:
    ...
    def get_sector_schema(
        self,
        category: Annotated[StrictStr, Field(description="ESPR product category (case-insensitive). Only `textiles`, `batteries`, `electronics`, `chemicals` and `construction` have published JSON Schemas; `cosmetics`, `toys`, `iron-steel` and `aluminium` return 404 here (their validation rules are built into the server).")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
