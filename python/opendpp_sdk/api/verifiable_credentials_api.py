...
class VerifiableCredentialsApi:
    ...
    @validate_call
    def get_tenant_did_document(
        self,
        tenant_id: Annotated[StrictStr, Field(description="The issuing workspace (tenant) id — the `{tenantId}` of its `did:web:opendpp-node.eu:tenants:{tenantId}` DID.")],
        ...
        :param tenant_id: The issuing workspace (tenant) id — the `{tenantId}` of its `did:web:opendpp-node.eu:tenants:{tenantId}` DID. (required)
        :type tenant_id: str
        ...
        _param = self._get_tenant_did_document_serialize(
            tenant_id=tenant_id,
    ...
    @validate_call
    def get_tenant_did_document_with_http_info(
        self,
        tenant_id: Annotated[StrictStr, Field(description="The issuing workspace (tenant) id — the `{tenantId}` of its `did:web:opendpp-node.eu:tenants:{tenantId}` DID.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_tenant_did_document_without_preload_content(
        self,
        tenant_id: Annotated[StrictStr, Field(description="The issuing workspace (tenant) id — the `{tenantId}` of its `did:web:opendpp-node.eu:tenants:{tenantId}` DID.")],
        _request_timeout: Union[
            None,
    ...
    def _get_tenant_did_document_serialize(
        self,
        tenant_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/tenants/{tenantId}/did.json',
    ...
    @validate_call
    def get_tenant_revocation_status_list(
        self,
        tenant_id: Annotated[StrictStr, Field(description="The issuing workspace (tenant) id.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param tenant_id: The issuing workspace (tenant) id. (required)
        :type tenant_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_tenant_revocation_status_list_serialize(
            tenant_id=tenant_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_tenant_revocation_status_list_with_http_info(
        self,
        tenant_id: Annotated[StrictStr, Field(description="The issuing workspace (tenant) id.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_tenant_revocation_status_list_without_preload_content(
        self,
        tenant_id: Annotated[StrictStr, Field(description="The issuing workspace (tenant) id.")],
        _request_timeout: Union[
            None,
    ...
    def _get_tenant_revocation_status_list_serialize(
        self,
        tenant_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/tenants/{tenantId}/status/revocation',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
