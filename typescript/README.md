...
`@opendpp/sdk` is **version-locked to `OPENAPI_VERSION`** — e.g. `@opendpp/sdk@1.8.0` targets API
contract `1.8.0`. The generated client under `src/generated/` is committed and CI-checked against
