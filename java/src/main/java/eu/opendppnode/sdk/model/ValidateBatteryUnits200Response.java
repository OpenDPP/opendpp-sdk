 ...
 */
@JsonPropertyOrder({
  ValidateBatteryUnits200Response.JSON_PROPERTY_SUCCESS,
  ValidateBatteryUnits200Response.JSON_PROPERTY_MESSAGE,
  ValidateBatteryUnits200Response.JSON_PROPERTY_COUNT,
  ValidateBatteryUnits200Response.JSON_PROPERTY_VALID_COUNT,
...
public class ValidateBatteryUnits200Response extends HashMap<String, Object> {
  ...
  @jakarta.annotation.Nonnull
  private List<ValidateBatteryUnits200ResponseResultsInner> results = new ArrayList<>();

  public ValidateBatteryUnits200Response() { 
  }

  public ValidateBatteryUnits200Response success(@jakarta.annotation.Nonnull Boolean success) {
  ...
  public ValidateBatteryUnits200Response message(@jakarta.annotation.Nullable String message) {
  ...
  public ValidateBatteryUnits200Response count(@jakarta.annotation.Nonnull Integer count) {
    this.count = count;
    return this;
  }
  ...
  public ValidateBatteryUnits200Response validCount(@jakarta.annotation.Nonnull Integer validCount) {
  ...
  @JsonProperty(JSON_PROPERTY_VALID_COUNT)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setValidCount(@jakarta.annotation.Nonnull Integer validCount) {
    this.validCount = validCount;
  }


  public ValidateBatteryUnits200Response results(@jakarta.annotation.Nonnull List<ValidateBatteryUnits200ResponseResultsInner> results) {
    this.results = results;
    return this;
  }

  public ValidateBatteryUnits200Response addResultsItem(ValidateBatteryUnits200ResponseResultsInner resultsItem) {
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public List<ValidateBatteryUnits200ResponseResultsInner> getResults() {
    return results;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RESULTS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setResults(@jakarta.annotation.Nonnull List<ValidateBatteryUnits200ResponseResultsInner> results) {
    this.results = results;
  }
  ...
  public boolean equals(Object o) {
    ...
    ValidateBatteryUnits200Response validateBatteryUnits200Response = (ValidateBatteryUnits200Response) o;
    return Objects.equals(this.success, validateBatteryUnits200Response.success) &&
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `validCount` to the URL query string
    if (getValidCount() != null) {
      joiner.add(String.format("%svalidCount%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getValidCount()))));
    }
