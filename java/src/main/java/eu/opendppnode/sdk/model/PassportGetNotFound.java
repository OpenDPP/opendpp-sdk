...
import eu.opendppnode.sdk.model.ForwardedResolverError;
...
@JsonDeserialize(using=PassportGetNotFound.PassportGetNotFoundDeserializer.class)
@JsonSerialize(using = PassportGetNotFound.PassportGetNotFoundSerializer.class)
public class PassportGetNotFound extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(PassportGetNotFound.class.getName());

    public static class PassportGetNotFoundSerializer extends StdSerializer<PassportGetNotFound> {
        public PassportGetNotFoundSerializer(Class<PassportGetNotFound> t) {
            super(t);
        }

        public PassportGetNotFoundSerializer() {
            this(null);
        }

        @Override
        public void serialize(PassportGetNotFound value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class PassportGetNotFoundDeserializer extends StdDeserializer<PassportGetNotFound> {
        public PassportGetNotFoundDeserializer() {
            this(PassportGetNotFound.class);
        }

        public PassportGetNotFoundDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public PassportGetNotFound deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                PassportGetNotFound ret = new PassportGetNotFound();
                ret.setActualInstance(deserialized);
                return ret;
            } catch (Exception e) {
                // deserialization failed, continue, log to help debugging
                log.log(Level.FINER, "Input data does not match 'PassportGetNotFound'", e);
            }

            // deserialize ForwardedResolverError
            try {
                deserialized = tree.traverse(jp.getCodec()).readValueAs(ForwardedResolverError.class);
                PassportGetNotFound ret = new PassportGetNotFound();
                ret.setActualInstance(deserialized);
                return ret;
            } catch (Exception e) {
            ...
            throw new IOException(String.format("Failed deserialization for PassportGetNotFound: no match found"));
        }
         ...
         */
        @Override
        public PassportGetNotFound getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "PassportGetNotFound cannot be null");
        }
    }
    ...
    public PassportGetNotFound() {
        super("anyOf", Boolean.FALSE);
    }

    public PassportGetNotFound(Error o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public PassportGetNotFound(ForwardedResolverError o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        schemas.put("ForwardedResolverError", ForwardedResolverError.class);
        JSON.registerDescendants(PassportGetNotFound.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return PassportGetNotFound.schemas;
    }

    /**
     * Set the instance that matches the anyOf child schema, check
     * the instance parameter is valid against the anyOf child schemas:
     * Error, ForwardedResolverError
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        if (JSON.isInstanceOf(ForwardedResolverError.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be Error, ForwardedResolverError");
    }
     ...
     * Error, ForwardedResolverError
     *
     * @return The actual instance (Error, ForwardedResolverError)
     */
    @Override
    ...
    /**
     * Get the actual instance of `ForwardedResolverError`. If the actual instance is not `ForwardedResolverError`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `ForwardedResolverError`
     * @throws ClassCastException if the instance is not `ForwardedResolverError`
     */
    public ForwardedResolverError getForwardedResolverError() throws ClassCastException {
        return (ForwardedResolverError)super.getActualInstance();
    }
