 ...
 */
@JsonPropertyOrder({
  PassportCreateValidationError.JSON_PROPERTY_SUCCESS,
  PassportCreateValidationError.JSON_PROPERTY_ERROR,
  PassportCreateValidationError.JSON_PROPERTY_MESSAGE,
  PassportCreateValidationError.JSON_PROPERTY_ERRORS,
  PassportCreateValidationError.JSON_PROPERTY_WARNINGS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class PassportCreateValidationError {
  ...
  public PassportCreateValidationError() { 
  }

  public PassportCreateValidationError success(@jakarta.annotation.Nonnull Boolean success) {
  ...
  public PassportCreateValidationError error(@jakarta.annotation.Nonnull ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public PassportCreateValidationError message(@jakarta.annotation.Nonnull String message) {
  ...
  public PassportCreateValidationError errors(@jakarta.annotation.Nonnull List<ValidationErrorItem> errors) {
    this.errors = errors;
    return this;
  }

  public PassportCreateValidationError addErrorsItem(ValidationErrorItem errorsItem) {
    if (this.errors == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ERRORS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setErrors(@jakarta.annotation.Nonnull List<ValidationErrorItem> errors) {
    this.errors = errors;
  }


  public PassportCreateValidationError warnings(@jakarta.annotation.Nullable List<ValidationErrorItem> warnings) {
    this.warnings = warnings;
    return this;
  }

  public PassportCreateValidationError addWarningsItem(ValidationErrorItem warningsItem) {
  ...
  @JsonProperty(JSON_PROPERTY_WARNINGS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setWarnings(@jakarta.annotation.Nullable List<ValidationErrorItem> warnings) {
    this.warnings = warnings;
  }


  /**
   * Return true if this PassportCreateValidationError object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PassportCreateValidationError passportCreateValidationError = (PassportCreateValidationError) o;
    return Objects.equals(this.success, passportCreateValidationError.success) &&
        Objects.equals(this.error, passportCreateValidationError.error) &&
        Objects.equals(this.message, passportCreateValidationError.message) &&
        Objects.equals(this.errors, passportCreateValidationError.errors) &&
        Objects.equals(this.warnings, passportCreateValidationError.warnings);
  }

  @Override
  public int hashCode() {
    return Objects.hash(success, error, message, errors, warnings);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PassportCreateValidationError {\n");
