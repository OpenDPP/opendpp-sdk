...
@JsonDeserialize(using=OperatorMinimalErrorResponse.OperatorMinimalErrorResponseDeserializer.class)
@JsonSerialize(using = OperatorMinimalErrorResponse.OperatorMinimalErrorResponseSerializer.class)
public class OperatorMinimalErrorResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(OperatorMinimalErrorResponse.class.getName());

    public static class OperatorMinimalErrorResponseSerializer extends StdSerializer<OperatorMinimalErrorResponse> {
        public OperatorMinimalErrorResponseSerializer(Class<OperatorMinimalErrorResponse> t) {
            super(t);
        }

        public OperatorMinimalErrorResponseSerializer() {
            this(null);
        }

        @Override
        public void serialize(OperatorMinimalErrorResponse value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class OperatorMinimalErrorResponseDeserializer extends StdDeserializer<OperatorMinimalErrorResponse> {
        public OperatorMinimalErrorResponseDeserializer() {
            this(OperatorMinimalErrorResponse.class);
        }

        public OperatorMinimalErrorResponseDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public OperatorMinimalErrorResponse deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                OperatorMinimalErrorResponse ret = new OperatorMinimalErrorResponse();
                ret.setActualInstance(deserialized);
                return ret;
            } catch (Exception e) {
                // deserialization failed, continue, log to help debugging
                log.log(Level.FINER, "Input data does not match 'OperatorMinimalErrorResponse'", e);
            }

            // deserialize OperatorMinimalError
            try {
                deserialized = tree.traverse(jp.getCodec()).readValueAs(OperatorMinimalError.class);
                OperatorMinimalErrorResponse ret = new OperatorMinimalErrorResponse();
                ret.setActualInstance(deserialized);
                return ret;
            } catch (Exception e) {
            ...
            throw new IOException(String.format("Failed deserialization for OperatorMinimalErrorResponse: no match found"));
        }
         ...
         */
        @Override
        public OperatorMinimalErrorResponse getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "OperatorMinimalErrorResponse cannot be null");
        }
    }
    ...
    public OperatorMinimalErrorResponse() {
        super("anyOf", Boolean.FALSE);
    }

    public OperatorMinimalErrorResponse(Error o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public OperatorMinimalErrorResponse(OperatorMinimalError o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        schemas.put("OperatorMinimalError", OperatorMinimalError.class);
        JSON.registerDescendants(OperatorMinimalErrorResponse.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return OperatorMinimalErrorResponse.schemas;
    }

    /**
     * Set the instance that matches the anyOf child schema, check
     * the instance parameter is valid against the anyOf child schemas:
     * Error, OperatorMinimalError
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        if (JSON.isInstanceOf(OperatorMinimalError.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be Error, OperatorMinimalError");
    }
     ...
     * Error, OperatorMinimalError
     *
     * @return The actual instance (Error, OperatorMinimalError)
     */
    @Override
    ...
    /**
     * Get the actual instance of `OperatorMinimalError`. If the actual instance is not `OperatorMinimalError`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `OperatorMinimalError`
     * @throws ClassCastException if the instance is not `OperatorMinimalError`
     */
    public OperatorMinimalError getOperatorMinimalError() throws ClassCastException {
        return (OperatorMinimalError)super.getActualInstance();
    }
