 ...
 */
@JsonPropertyOrder({
  ForwardedResolverRateLimitError.JSON_PROPERTY_ERROR,
  ForwardedResolverRateLimitError.JSON_PROPERTY_MESSAGE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class ForwardedResolverRateLimitError {
  ...
  public ForwardedResolverRateLimitError() { 
  }

  public ForwardedResolverRateLimitError error(@jakarta.annotation.Nonnull String error) {
    this.error = error;
    return this;
  }
  ...
  public ForwardedResolverRateLimitError message(@jakarta.annotation.Nonnull String message) {
  ...
  /**
   * Return true if this ForwardedResolverRateLimitError object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ForwardedResolverRateLimitError forwardedResolverRateLimitError = (ForwardedResolverRateLimitError) o;
    return Objects.equals(this.error, forwardedResolverRateLimitError.error) &&
        Objects.equals(this.message, forwardedResolverRateLimitError.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class ForwardedResolverRateLimitError {\n");
