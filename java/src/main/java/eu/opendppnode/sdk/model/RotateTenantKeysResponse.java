 ...
 */
@JsonPropertyOrder({
  RotateTenantKeysResponse.JSON_PROPERTY_SUCCESS,
  RotateTenantKeysResponse.JSON_PROPERTY_MESSAGE,
  RotateTenantKeysResponse.JSON_PROPERTY_PUBLIC_KEY
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class RotateTenantKeysResponse {
  /**
  ...
  public RotateTenantKeysResponse() { 
  }

  public RotateTenantKeysResponse success(@jakarta.annotation.Nonnull SuccessEnum success) {
  ...
  public RotateTenantKeysResponse message(@jakarta.annotation.Nonnull String message) {
  ...
  public RotateTenantKeysResponse publicKey(@jakarta.annotation.Nonnull String publicKey) {
  ...
  /**
   * Return true if this RotateTenantKeysResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    RotateTenantKeysResponse rotateTenantKeysResponse = (RotateTenantKeysResponse) o;
    return Objects.equals(this.success, rotateTenantKeysResponse.success) &&
        Objects.equals(this.message, rotateTenantKeysResponse.message) &&
        Objects.equals(this.publicKey, rotateTenantKeysResponse.publicKey);
  }

  @Override
  public int hashCode() {
    return Objects.hash(success, message, publicKey);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RotateTenantKeysResponse {\n");
