 ...
 */
@JsonPropertyOrder({
  SectorJsonSchemaDocument.JSON_PROPERTY_$_SCHEMA,
  SectorJsonSchemaDocument.JSON_PROPERTY_TITLE,
  SectorJsonSchemaDocument.JSON_PROPERTY_TYPE,
  SectorJsonSchemaDocument.JSON_PROPERTY_REQUIRED,
...
public class SectorJsonSchemaDocument {
  ...
  public SectorJsonSchemaDocument title(@jakarta.annotation.Nonnull String title) {
    this.title = title;
    return this;
  }
  ...
  public SectorJsonSchemaDocument required(@jakarta.annotation.Nonnull List<String> required) {
    this.required = required;
    return this;
  }

  public SectorJsonSchemaDocument addRequiredItem(String requiredItem) {
  ...
  public boolean equals(Object o) {
    ...
    SectorJsonSchemaDocument sectorJsonSchemaDocument = (SectorJsonSchemaDocument) o;
    return Objects.equals(this.$schema, sectorJsonSchemaDocument.$schema) &&
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (get$Schema() != null) {
      joiner.add(String.format("%s$schema%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(get$Schema()))));
    }
    ...
    if (getRequired() != null) {
      for (int i = 0; i < getRequired().size(); i++) {
        joiner.add(String.format("%srequired%s%s=%s", prefix, suffix,
