 ...
 */
@JsonPropertyOrder({
  BatteryUnitDynamicDataEvent.JSON_PROPERTY_AT_TYPE,
  BatteryUnitDynamicDataEvent.JSON_PROPERTY_EVENT_TYPE,
  BatteryUnitDynamicDataEvent.JSON_PROPERTY_STATE_OF_HEALTH,
  BatteryUnitDynamicDataEvent.JSON_PROPERTY_CYCLE_COUNT,
  BatteryUnitDynamicDataEvent.JSON_PROPERTY_REMAINING_CAPACITY_AH,
  BatteryUnitDynamicDataEvent.JSON_PROPERTY_TEMPERATURE_C,
  BatteryUnitDynamicDataEvent.JSON_PROPERTY_PAYLOAD,
  BatteryUnitDynamicDataEvent.JSON_PROPERTY_RECORDED_AT
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class BatteryUnitDynamicDataEvent {
  /**
   * Gets or Sets atType
   */
  ...
  public BatteryUnitDynamicDataEvent() { 
  }

  public BatteryUnitDynamicDataEvent atType(@jakarta.annotation.Nonnull AtTypeEnum atType) {
    this.atType = atType;
    return this;
  }
  ...
  public BatteryUnitDynamicDataEvent eventType(@jakarta.annotation.Nonnull BatteryUnitEventType eventType) {
  ...
  public BatteryUnitDynamicDataEvent stateOfHealth(@jakarta.annotation.Nullable BigDecimal stateOfHealth) {
  ...
  public BatteryUnitDynamicDataEvent cycleCount(@jakarta.annotation.Nullable Integer cycleCount) {
  ...
  public BatteryUnitDynamicDataEvent remainingCapacityAh(@jakarta.annotation.Nullable BigDecimal remainingCapacityAh) {
  ...
  public BatteryUnitDynamicDataEvent temperatureC(@jakarta.annotation.Nullable BigDecimal temperatureC) {
  ...
  public BatteryUnitDynamicDataEvent payload(@jakarta.annotation.Nullable Object payload) {
  ...
  public BatteryUnitDynamicDataEvent recordedAt(@jakarta.annotation.Nonnull OffsetDateTime recordedAt) {
  ...
  /**
   * Return true if this BatteryUnitDynamicDataEvent object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    BatteryUnitDynamicDataEvent batteryUnitDynamicDataEvent = (BatteryUnitDynamicDataEvent) o;
    return Objects.equals(this.atType, batteryUnitDynamicDataEvent.atType) &&
        Objects.equals(this.eventType, batteryUnitDynamicDataEvent.eventType) &&
        Objects.equals(this.stateOfHealth, batteryUnitDynamicDataEvent.stateOfHealth) &&
        Objects.equals(this.cycleCount, batteryUnitDynamicDataEvent.cycleCount) &&
        Objects.equals(this.remainingCapacityAh, batteryUnitDynamicDataEvent.remainingCapacityAh) &&
        Objects.equals(this.temperatureC, batteryUnitDynamicDataEvent.temperatureC) &&
        Objects.equals(this.payload, batteryUnitDynamicDataEvent.payload) &&
        Objects.equals(this.recordedAt, batteryUnitDynamicDataEvent.recordedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class BatteryUnitDynamicDataEvent {\n");
