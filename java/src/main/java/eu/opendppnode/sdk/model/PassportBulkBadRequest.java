...
@JsonDeserialize(using = PassportBulkBadRequest.PassportBulkBadRequestDeserializer.class)
@JsonSerialize(using = PassportBulkBadRequest.PassportBulkBadRequestSerializer.class)
public class PassportBulkBadRequest extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(PassportBulkBadRequest.class.getName());

    public static class PassportBulkBadRequestSerializer extends StdSerializer<PassportBulkBadRequest> {
        public PassportBulkBadRequestSerializer(Class<PassportBulkBadRequest> t) {
            super(t);
        }

        public PassportBulkBadRequestSerializer() {
            this(null);
        }

        @Override
        public void serialize(PassportBulkBadRequest value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class PassportBulkBadRequestDeserializer extends StdDeserializer<PassportBulkBadRequest> {
        public PassportBulkBadRequestDeserializer() {
            this(PassportBulkBadRequest.class);
        }

        public PassportBulkBadRequestDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public PassportBulkBadRequest deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                PassportBulkBadRequest ret = new PassportBulkBadRequest();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format("Failed deserialization for PassportBulkBadRequest: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public PassportBulkBadRequest getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "PassportBulkBadRequest cannot be null");
        }
    }
    ...
    public PassportBulkBadRequest() {
        super("oneOf", Boolean.FALSE);
    }

    public PassportBulkBadRequest(DefaultRequestRejectionError o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public PassportBulkBadRequest(PassportBulkFailure o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(PassportBulkBadRequest.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return PassportBulkBadRequest.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * DefaultRequestRejectionError, PassportBulkFailure
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be DefaultRequestRejectionError, PassportBulkFailure");
    }
     ...
     * DefaultRequestRejectionError, PassportBulkFailure
     *
     * @return The actual instance (DefaultRequestRejectionError, PassportBulkFailure)
     */
    @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getActualInstance() instanceof DefaultRequestRejectionError) {
        if (getActualInstance() != null) {
          joiner.add(((DefaultRequestRejectionError)getActualInstance()).toUrlQueryString(prefix + "one_of_1" + suffix));
        }
        return joiner.toString();
    }
    return null;
