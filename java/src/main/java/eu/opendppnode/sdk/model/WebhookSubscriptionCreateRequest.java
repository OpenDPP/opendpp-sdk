 ...
 */
@JsonPropertyOrder({
  WebhookSubscriptionCreateRequest.JSON_PROPERTY_URL,
  WebhookSubscriptionCreateRequest.JSON_PROPERTY_EVENTS
})
...
public class WebhookSubscriptionCreateRequest {
  ...
  public WebhookSubscriptionCreateRequest url(@jakarta.annotation.Nonnull URI url) {
    this.url = url;
    return this;
  }
  ...
  public WebhookSubscriptionCreateRequest events(@jakarta.annotation.Nonnull List<WebhookEventFilter> events) {
    this.events = events;
    return this;
  }

  public WebhookSubscriptionCreateRequest addEventsItem(WebhookEventFilter eventsItem) {
    if (this.events == null) {
  ...
  /**
   * Return true if this WebhookSubscriptionCreateRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.url, webhookSubscriptionCreateRequest.url) &&
        Objects.equals(this.events, webhookSubscriptionCreateRequest.events);
  }
