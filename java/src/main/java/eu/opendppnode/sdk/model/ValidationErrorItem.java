 ...
 */
@JsonPropertyOrder({
  ValidationErrorItem.JSON_PROPERTY_PATH,
  ValidationErrorItem.JSON_PROPERTY_MESSAGE,
  ValidationErrorItem.JSON_PROPERTY_FRIENDLY_MESSAGE
})
...
public class ValidationErrorItem {
  ...
  public ValidationErrorItem path(@jakarta.annotation.Nonnull String path) {
    this.path = path;
    return this;
  }
  ...
  public ValidationErrorItem message(@jakarta.annotation.Nonnull String message) {
  ...
  public ValidationErrorItem friendlyMessage(@jakarta.annotation.Nullable String friendlyMessage) {
  ...
  @JsonProperty(JSON_PROPERTY_FRIENDLY_MESSAGE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFriendlyMessage(@jakarta.annotation.Nullable String friendlyMessage) {
    this.friendlyMessage = friendlyMessage;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.path, validationErrorItem.path) &&
        Objects.equals(this.message, validationErrorItem.message) &&
        Objects.equals(this.friendlyMessage, validationErrorItem.friendlyMessage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(path, message, friendlyMessage);
  }
