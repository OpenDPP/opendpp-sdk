 ...
 */
@JsonPropertyOrder({
  PassportCreateRequest.JSON_PROPERTY_PRODUCT_ID,
  PassportCreateRequest.JSON_PROPERTY_OPERATOR_ID,
  PassportCreateRequest.JSON_PROPERTY_FACILITY_ID,
  PassportCreateRequest.JSON_PROPERTY_METADATA,
  PassportCreateRequest.JSON_PROPERTY_DRAFT,
  PassportCreateRequest.JSON_PROPERTY_ENRICHMENT,
  PassportCreateRequest.JSON_PROPERTY_CARRIER
})
...
public class PassportCreateRequest {
  ...
  @jakarta.annotation.Nullable
  private PassportEnrichmentInput enrichment;

  public static final String JSON_PROPERTY_CARRIER = "carrier";
  @jakarta.annotation.Nullable
  private CarrierDeclaration carrier;

  public PassportCreateRequest() { 
  }

  public PassportCreateRequest productId(@jakarta.annotation.Nonnull String productId) {
  ...
  public PassportCreateRequest operatorId(@jakarta.annotation.Nullable String operatorId) {
  ...
  public PassportCreateRequest facilityId(@jakarta.annotation.Nullable String facilityId) {
  ...
  public PassportCreateRequest metadata(@jakarta.annotation.Nonnull PassportMetadataInput metadata) {
  ...
  @JsonProperty(JSON_PROPERTY_METADATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setMetadata(@jakarta.annotation.Nonnull PassportMetadataInput metadata) {
    this.metadata = metadata;
  }


  public PassportCreateRequest draft(@jakarta.annotation.Nullable Boolean draft) {
    this.draft = draft;
    return this;
  }
  ...
  public PassportCreateRequest enrichment(@jakarta.annotation.Nullable PassportEnrichmentInput enrichment) {
  ...
  public PassportCreateRequest carrier(@jakarta.annotation.Nullable CarrierDeclaration carrier) {
  ...
  /**
   * Return true if this PassportCreateRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PassportCreateRequest passportCreateRequest = (PassportCreateRequest) o;
    return Objects.equals(this.productId, passportCreateRequest.productId) &&
        Objects.equals(this.operatorId, passportCreateRequest.operatorId) &&
        Objects.equals(this.facilityId, passportCreateRequest.facilityId) &&
        Objects.equals(this.metadata, passportCreateRequest.metadata) &&
        Objects.equals(this.draft, passportCreateRequest.draft) &&
        Objects.equals(this.enrichment, passportCreateRequest.enrichment) &&
        Objects.equals(this.carrier, passportCreateRequest.carrier);
  }

  @Override
  public int hashCode() {
    return Objects.hash(productId, operatorId, facilityId, metadata, draft, enrichment, carrier);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PassportCreateRequest {\n");
