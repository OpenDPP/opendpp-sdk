...
@JsonDeserialize(using=PassportUpdateBadRequest.PassportUpdateBadRequestDeserializer.class)
@JsonSerialize(using = PassportUpdateBadRequest.PassportUpdateBadRequestSerializer.class)
public class PassportUpdateBadRequest extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(PassportUpdateBadRequest.class.getName());

    public static class PassportUpdateBadRequestSerializer extends StdSerializer<PassportUpdateBadRequest> {
        public PassportUpdateBadRequestSerializer(Class<PassportUpdateBadRequest> t) {
            super(t);
        }

        public PassportUpdateBadRequestSerializer() {
            this(null);
        }

        @Override
        public void serialize(PassportUpdateBadRequest value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class PassportUpdateBadRequestDeserializer extends StdDeserializer<PassportUpdateBadRequest> {
        public PassportUpdateBadRequestDeserializer() {
            this(PassportUpdateBadRequest.class);
        }

        public PassportUpdateBadRequestDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public PassportUpdateBadRequest deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                PassportUpdateBadRequest ret = new PassportUpdateBadRequest();
                ret.setActualInstance(deserialized);
                return ret;
            } catch (Exception e) {
                // deserialization failed, continue, log to help debugging
                log.log(Level.FINER, "Input data does not match 'PassportUpdateBadRequest'", e);
            }
            ...
            throw new IOException(String.format("Failed deserialization for PassportUpdateBadRequest: no match found"));
        }
         ...
         */
        @Override
        public PassportUpdateBadRequest getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "PassportUpdateBadRequest cannot be null");
        }
    }
    ...
    public PassportUpdateBadRequest() {
        super("anyOf", Boolean.FALSE);
    }

    public PassportUpdateBadRequest(Error o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public PassportUpdateBadRequest(PassportUpdateValidationError o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(PassportUpdateBadRequest.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return PassportUpdateBadRequest.schemas;
    }
