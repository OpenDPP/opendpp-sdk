 ...
 */
@JsonPropertyOrder({
  ServiceVersion.JSON_PROPERTY_API_VERSION,
  ServiceVersion.JSON_PROPERTY_COMMIT,
  ServiceVersion.JSON_PROPERTY_BUILT_AT
})
...
public class ServiceVersion {
  ...
  public ServiceVersion apiVersion(@jakarta.annotation.Nonnull String apiVersion) {
  ...
  public ServiceVersion commit(@jakarta.annotation.Nonnull String commit) {
    this.commit = commit;
    return this;
  }
  ...
  public ServiceVersion builtAt(@jakarta.annotation.Nonnull String builtAt) {
  ...
  /**
   * Return true if this ServiceVersion object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.apiVersion, serviceVersion.apiVersion) &&
        Objects.equals(this.commit, serviceVersion.commit) &&
        Objects.equals(this.builtAt, serviceVersion.builtAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(apiVersion, commit, builtAt);
  }
