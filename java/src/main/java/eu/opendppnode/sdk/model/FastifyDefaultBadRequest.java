 ...
 */
@JsonPropertyOrder({
  FastifyDefaultBadRequest.JSON_PROPERTY_STATUS_CODE,
  FastifyDefaultBadRequest.JSON_PROPERTY_CODE,
  FastifyDefaultBadRequest.JSON_PROPERTY_ERROR,
  FastifyDefaultBadRequest.JSON_PROPERTY_MESSAGE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class FastifyDefaultBadRequest {
  /**
  ...
  public FastifyDefaultBadRequest() { 
  }

  public FastifyDefaultBadRequest statusCode(@jakarta.annotation.Nonnull StatusCodeEnum statusCode) {
  ...
  public FastifyDefaultBadRequest code(@jakarta.annotation.Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public FastifyDefaultBadRequest error(@jakarta.annotation.Nonnull ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public FastifyDefaultBadRequest message(@jakarta.annotation.Nonnull String message) {
  ...
  /**
   * Return true if this FastifyDefaultBadRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    FastifyDefaultBadRequest fastifyDefaultBadRequest = (FastifyDefaultBadRequest) o;
    return Objects.equals(this.statusCode, fastifyDefaultBadRequest.statusCode) &&
        Objects.equals(this.code, fastifyDefaultBadRequest.code) &&
        Objects.equals(this.error, fastifyDefaultBadRequest.error) &&
        Objects.equals(this.message, fastifyDefaultBadRequest.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class FastifyDefaultBadRequest {\n");
