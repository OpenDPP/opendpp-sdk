 ...
 */
@JsonPropertyOrder({
  BatteryUnitListResponse.JSON_PROPERTY_SUCCESS,
  BatteryUnitListResponse.JSON_PROPERTY_COUNT,
  BatteryUnitListResponse.JSON_PROPERTY_PRODUCT_ID,
  BatteryUnitListResponse.JSON_PROPERTY_UNITS,
  BatteryUnitListResponse.JSON_PROPERTY_PAGE,
  BatteryUnitListResponse.JSON_PROPERTY_LIMIT,
  BatteryUnitListResponse.JSON_PROPERTY_TOTAL,
  BatteryUnitListResponse.JSON_PROPERTY_TOTAL_PAGES
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class BatteryUnitListResponse {
  /**
  ...
  public BatteryUnitListResponse() { 
  }

  public BatteryUnitListResponse success(@jakarta.annotation.Nonnull SuccessEnum success) {
  ...
  public BatteryUnitListResponse count(@jakarta.annotation.Nonnull Integer count) {
    this.count = count;
    return this;
  }
  ...
  public BatteryUnitListResponse productId(@jakarta.annotation.Nonnull String productId) {
  ...
  public BatteryUnitListResponse units(@jakarta.annotation.Nonnull List<BatteryUnitRow> units) {
    this.units = units;
    return this;
  }

  public BatteryUnitListResponse addUnitsItem(BatteryUnitRow unitsItem) {
    if (this.units == null) {
  ...
  public BatteryUnitListResponse page(@jakarta.annotation.Nonnull Integer page) {
    this.page = page;
    return this;
  }
  ...
  public BatteryUnitListResponse limit(@jakarta.annotation.Nonnull Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public BatteryUnitListResponse total(@jakarta.annotation.Nonnull Integer total) {
    this.total = total;
    return this;
  }
  ...
  public BatteryUnitListResponse totalPages(@jakarta.annotation.Nonnull Integer totalPages) {
  ...
  /**
   * Return true if this BatteryUnitListResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    BatteryUnitListResponse batteryUnitListResponse = (BatteryUnitListResponse) o;
    return Objects.equals(this.success, batteryUnitListResponse.success) &&
        Objects.equals(this.count, batteryUnitListResponse.count) &&
        Objects.equals(this.productId, batteryUnitListResponse.productId) &&
        Objects.equals(this.units, batteryUnitListResponse.units) &&
        Objects.equals(this.page, batteryUnitListResponse.page) &&
        Objects.equals(this.limit, batteryUnitListResponse.limit) &&
        Objects.equals(this.total, batteryUnitListResponse.total) &&
        Objects.equals(this.totalPages, batteryUnitListResponse.totalPages);
  }

  @Override
  public int hashCode() {
    return Objects.hash(success, count, productId, units, page, limit, total, totalPages);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BatteryUnitListResponse {\n");
