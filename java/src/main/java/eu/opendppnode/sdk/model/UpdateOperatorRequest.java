 ...
 */
@JsonPropertyOrder({
  UpdateOperatorRequest.JSON_PROPERTY_NAME,
  UpdateOperatorRequest.JSON_PROPERTY_ROLE,
  UpdateOperatorRequest.JSON_PROPERTY_EORI,
  UpdateOperatorRequest.JSON_PROPERTY_REG_ID_SCHEME,
  UpdateOperatorRequest.JSON_PROPERTY_REG_ID
})
...
public class UpdateOperatorRequest {
  ...
  public UpdateOperatorRequest name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateOperatorRequest role(@jakarta.annotation.Nullable String role) {
    this.role = role;
    return this;
  }
  ...
  public UpdateOperatorRequest eori(@jakarta.annotation.Nullable String eori) {
  ...
  public UpdateOperatorRequest regIdScheme(@jakarta.annotation.Nullable RegIdSchemeEnum regIdScheme) {
  ...
  public UpdateOperatorRequest regId(@jakarta.annotation.Nullable String regId) {
    this.regId = regId;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_REG_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRegId(@jakarta.annotation.Nullable String regId) {
    this.regId = regId;
  }


  /**
   * Return true if this UpdateOperatorRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    UpdateOperatorRequest updateOperatorRequest = (UpdateOperatorRequest) o;
    return Objects.equals(this.name, updateOperatorRequest.name) &&
        Objects.equals(this.role, updateOperatorRequest.role) &&
        equalsNullable(this.eori, updateOperatorRequest.eori) &&
        Objects.equals(this.regIdScheme, updateOperatorRequest.regIdScheme) &&
        Objects.equals(this.regId, updateOperatorRequest.regId);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, role, hashCodeNullable(eori), regIdScheme, regId);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateOperatorRequest {\n");
