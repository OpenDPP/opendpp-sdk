 ...
 */
@JsonPropertyOrder({
  ForwardedResolverError.JSON_PROPERTY_ERROR,
  ForwardedResolverError.JSON_PROPERTY_MESSAGE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class ForwardedResolverError {
  ...
  public ForwardedResolverError() { 
  }

  public ForwardedResolverError error(@jakarta.annotation.Nonnull String error) {
    this.error = error;
    return this;
  }
  ...
  public ForwardedResolverError message(@jakarta.annotation.Nonnull String message) {
  ...
  /**
   * Return true if this ForwardedResolverError object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ForwardedResolverError forwardedResolverError = (ForwardedResolverError) o;
    return Objects.equals(this.error, forwardedResolverError.error) &&
        Objects.equals(this.message, forwardedResolverError.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class ForwardedResolverError {\n");
