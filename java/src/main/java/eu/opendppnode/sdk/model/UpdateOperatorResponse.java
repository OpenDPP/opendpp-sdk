 ...
 */
@JsonPropertyOrder({
  UpdateOperatorResponse.JSON_PROPERTY_SUCCESS,
  UpdateOperatorResponse.JSON_PROPERTY_OPERATOR
})
...
public class UpdateOperatorResponse {
  ...
  public UpdateOperatorResponse success(@jakarta.annotation.Nonnull SuccessEnum success) {
  ...
  public UpdateOperatorResponse operator(@jakarta.annotation.Nonnull OperatorRow operator) {
  ...
  /**
   * Return true if this UpdateOperatorResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    UpdateOperatorResponse updateOperatorResponse = (UpdateOperatorResponse) o;
    return Objects.equals(this.success, updateOperatorResponse.success) &&
        Objects.equals(this.operator, updateOperatorResponse.operator);
  }

  @Override
  public int hashCode() {
    return Objects.hash(success, operator);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UpdateOperatorResponse {\n");
