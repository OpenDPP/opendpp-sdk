...
@JsonPropertyOrder({
  ...
  BatteryUnitEventListResponse.JSON_PROPERTY_NEXT_CURSOR,
...
public class BatteryUnitEventListResponse {
  ...
  public BatteryUnitEventListResponse success(@jakarta.annotation.Nonnull Boolean success) {
  ...
  public BatteryUnitEventListResponse nextCursor(@jakarta.annotation.Nullable String nextCursor) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.success, batteryUnitEventListResponse.success) &&
        ...
        Objects.equals(this.nextCursor, batteryUnitEventListResponse.nextCursor) &&
        Objects.equals(this.events, batteryUnitEventListResponse.events);
  }

  @Override
  public int hashCode() {
    return Objects.hash(success, count, serialNumber, nextCursor, events);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getNextCursor() != null) {
      joiner.add(String.format("%snextCursor%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getNextCursor()))));
    }
