 ...
 */
@JsonPropertyOrder({
  PassportValidateOnlyError.JSON_PROPERTY_SUCCESS,
  PassportValidateOnlyError.JSON_PROPERTY_ERROR,
  PassportValidateOnlyError.JSON_PROPERTY_MESSAGE,
  PassportValidateOnlyError.JSON_PROPERTY_CATEGORY,
  PassportValidateOnlyError.JSON_PROPERTY_ERRORS,
  PassportValidateOnlyError.JSON_PROPERTY_WARNINGS
})
...
public class PassportValidateOnlyError {
  ...
  public PassportValidateOnlyError error(@jakarta.annotation.Nonnull ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public PassportValidateOnlyError message(@jakarta.annotation.Nonnull String message) {
  ...
  public PassportValidateOnlyError category(@jakarta.annotation.Nullable String category) {
  ...
  public PassportValidateOnlyError errors(@jakarta.annotation.Nullable List<ValidationErrorItem> errors) {
    this.errors = errors;
    return this;
  }

  public PassportValidateOnlyError addErrorsItem(ValidationErrorItem errorsItem) {
    if (this.errors == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ERRORS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setErrors(@jakarta.annotation.Nullable List<ValidationErrorItem> errors) {
    this.errors = errors;
  }


  public PassportValidateOnlyError warnings(@jakarta.annotation.Nullable List<ValidationErrorItem> warnings) {
    this.warnings = warnings;
    return this;
  }

  public PassportValidateOnlyError addWarningsItem(ValidationErrorItem warningsItem) {
  ...
  /**
   * Return true if this PassportValidateOnlyError object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PassportValidateOnlyError passportValidateOnlyError = (PassportValidateOnlyError) o;
    return Objects.equals(this.success, passportValidateOnlyError.success) &&
        Objects.equals(this.error, passportValidateOnlyError.error) &&
        Objects.equals(this.message, passportValidateOnlyError.message) &&
        Objects.equals(this.category, passportValidateOnlyError.category) &&
        Objects.equals(this.errors, passportValidateOnlyError.errors) &&
        Objects.equals(this.warnings, passportValidateOnlyError.warnings);
  }

  @Override
  public int hashCode() {
    return Objects.hash(success, error, message, category, errors, warnings);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PassportValidateOnlyError {\n");
