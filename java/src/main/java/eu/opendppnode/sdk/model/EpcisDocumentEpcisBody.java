...
/**
 * EpcisDocumentEpcisBody
 */
@JsonPropertyOrder({
  EpcisDocumentEpcisBody.JSON_PROPERTY_EVENT_LIST
})
...
public class EpcisDocumentEpcisBody {
  ...
  /**
   * Return true if this EpcisDocument_epcisBody object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    EpcisDocumentEpcisBody epcisDocumentEpcisBody = (EpcisDocumentEpcisBody) o;
    return Objects.equals(this.eventList, epcisDocumentEpcisBody.eventList);
  }
  ...
  public String toString() {
    ...
    sb.append("class EpcisDocumentEpcisBody {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `eventList` to the URL query string
    if (getEventList() != null) {
      for (int i = 0; i < getEventList().size(); i++) {
        joiner.add(String.format("%seventList%s%s=%s", prefix, suffix,
            "".equals(suffix) ? "" : String.format("%s%d%s", containerPrefix, i, containerSuffix),
            ApiClient.urlEncode(ApiClient.valueToString(getEventList().get(i)))));
      }
    }
