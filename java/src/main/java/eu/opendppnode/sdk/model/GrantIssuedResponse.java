 ...
 */
@JsonPropertyOrder({
  GrantIssuedResponse.JSON_PROPERTY_SUCCESS,
  GrantIssuedResponse.JSON_PROPERTY_GRANT,
  GrantIssuedResponse.JSON_PROPERTY_TOKEN
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class GrantIssuedResponse {
  /**
  ...
  @jakarta.annotation.Nonnull
  private GrantRow grant;

  public static final String JSON_PROPERTY_TOKEN = "token";
  @jakarta.annotation.Nonnull
  private String token;

  public GrantIssuedResponse() { 
  }

  public GrantIssuedResponse success(@jakarta.annotation.Nonnull SuccessEnum success) {
  ...
  public GrantIssuedResponse grant(@jakarta.annotation.Nonnull GrantRow grant) {
    this.grant = grant;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_GRANT)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setGrant(@jakarta.annotation.Nonnull GrantRow grant) {
    this.grant = grant;
  }


  public GrantIssuedResponse token(@jakarta.annotation.Nonnull String token) {
    this.token = token;
    return this;
  }
  ...
  /**
   * Return true if this GrantIssuedResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GrantIssuedResponse grantIssuedResponse = (GrantIssuedResponse) o;
    return Objects.equals(this.success, grantIssuedResponse.success) &&
        Objects.equals(this.grant, grantIssuedResponse.grant) &&
        Objects.equals(this.token, grantIssuedResponse.token);
  }

  @Override
  public int hashCode() {
    return Objects.hash(success, grant, token);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GrantIssuedResponse {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `grant` to the URL query string
    if (getGrant() != null) {
      joiner.add(getGrant().toUrlQueryString(prefix + "grant" + suffix));
    }
