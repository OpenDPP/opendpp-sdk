 ...
 */
@JsonPropertyOrder({
  RegisterOperatorRequest.JSON_PROPERTY_NAME,
  RegisterOperatorRequest.JSON_PROPERTY_REG_ID,
  RegisterOperatorRequest.JSON_PROPERTY_REG_ID_SCHEME,
  RegisterOperatorRequest.JSON_PROPERTY_EORI,
  RegisterOperatorRequest.JSON_PROPERTY_ROLE
})
...
public class RegisterOperatorRequest {
  ...
  private JsonNullable<String> eori = JsonNullable.<String>undefined();

  public static final String JSON_PROPERTY_ROLE = "role";
  @jakarta.annotation.Nullable
  private String role = "MANUFACTURER";

  public RegisterOperatorRequest() { 
  }

  public RegisterOperatorRequest name(@jakarta.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public RegisterOperatorRequest regId(@jakarta.annotation.Nonnull String regId) {
    this.regId = regId;
    return this;
  }
  ...
  public RegisterOperatorRequest regIdScheme(@jakarta.annotation.Nonnull RegIdSchemeEnum regIdScheme) {
  ...
  public RegisterOperatorRequest eori(@jakarta.annotation.Nullable String eori) {
    this.eori = JsonNullable.<String>of(eori);
    return this;
  }
  ...
  public String getEori() {
        return eori.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_EORI)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<String> getEori_JsonNullable() {
    return eori;
  }
  
  @JsonProperty(JSON_PROPERTY_EORI)
  public void setEori_JsonNullable(JsonNullable<String> eori) {
    this.eori = eori;
  }
  ...
  public RegisterOperatorRequest role(@jakarta.annotation.Nullable String role) {
    this.role = role;
    return this;
  }
  ...
  /**
   * Return true if this RegisterOperatorRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    RegisterOperatorRequest registerOperatorRequest = (RegisterOperatorRequest) o;
    return Objects.equals(this.name, registerOperatorRequest.name) &&
        Objects.equals(this.regId, registerOperatorRequest.regId) &&
        Objects.equals(this.regIdScheme, registerOperatorRequest.regIdScheme) &&
        equalsNullable(this.eori, registerOperatorRequest.eori) &&
        Objects.equals(this.role, registerOperatorRequest.role);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, regId, regIdScheme, hashCodeNullable(eori), role);
  }
  ...
  public String toString() {
    ...
    sb.append("class RegisterOperatorRequest {\n");
