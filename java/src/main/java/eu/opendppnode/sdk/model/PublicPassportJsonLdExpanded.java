...
import eu.opendppnode.sdk.model.En18223DataElement;
 ...
 */
@JsonPropertyOrder({
  PublicPassportJsonLdExpanded.JSON_PROPERTY_AT_CONTEXT,
  PublicPassportJsonLdExpanded.JSON_PROPERTY_AT_TYPE,
  PublicPassportJsonLdExpanded.JSON_PROPERTY_AT_ID,
  PublicPassportJsonLdExpanded.JSON_PROPERTY_ID,
  PublicPassportJsonLdExpanded.JSON_PROPERTY_PRODUCT_ID,
  PublicPassportJsonLdExpanded.JSON_PROPERTY_DIGITAL_LINK_URI,
  PublicPassportJsonLdExpanded.JSON_PROPERTY_PRODUCT_ID_SCHEME,
  PublicPassportJsonLdExpanded.JSON_PROPERTY_DIGITAL_PRODUCT_PASSPORT_ID,
  PublicPassportJsonLdExpanded.JSON_PROPERTY_UNIQUE_PRODUCT_IDENTIFIER,
  PublicPassportJsonLdExpanded.JSON_PROPERTY_GRANULARITY,
  PublicPassportJsonLdExpanded.JSON_PROPERTY_DPP_SCHEMA_VERSION,
  PublicPassportJsonLdExpanded.JSON_PROPERTY_DPP_STATUS,
  PublicPassportJsonLdExpanded.JSON_PROPERTY_LAST_UPDATED,
  PublicPassportJsonLdExpanded.JSON_PROPERTY_ECONOMIC_OPERATOR_ID,
  PublicPassportJsonLdExpanded.JSON_PROPERTY_FACILITY_ID,
  PublicPassportJsonLdExpanded.JSON_PROPERTY_CONTENT_SPECIFICATION_IDS,
  PublicPassportJsonLdExpanded.JSON_PROPERTY_DIGITAL_SEAL,
  PublicPassportJsonLdExpanded.JSON_PROPERTY_SIGNING_PUBLIC_KEY,
  PublicPassportJsonLdExpanded.JSON_PROPERTY_STATUS,
  PublicPassportJsonLdExpanded.JSON_PROPERTY_ARCHIVED_AT,
  PublicPassportJsonLdExpanded.JSON_PROPERTY_RETENTION_UNTIL,
  PublicPassportJsonLdExpanded.JSON_PROPERTY_PROOF,
  PublicPassportJsonLdExpanded.JSON_PROPERTY_ELEMENTS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class PublicPassportJsonLdExpanded {
  ...
  public PublicPassportJsonLdExpanded() { 
  }

  public PublicPassportJsonLdExpanded atContext(@jakarta.annotation.Nullable Object atContext) {
  ...
  public PublicPassportJsonLdExpanded atType(@jakarta.annotation.Nonnull AtTypeEnum atType) {
    this.atType = atType;
    return this;
  }
  ...
  public PublicPassportJsonLdExpanded atId(@jakarta.annotation.Nonnull URI atId) {
    this.atId = atId;
    return this;
  }
  ...
  public PublicPassportJsonLdExpanded id(@jakarta.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public PublicPassportJsonLdExpanded productId(@jakarta.annotation.Nonnull String productId) {
  ...
  public PublicPassportJsonLdExpanded digitalLinkUri(@jakarta.annotation.Nonnull URI digitalLinkUri) {
  ...
  public PublicPassportJsonLdExpanded productIdScheme(@jakarta.annotation.Nonnull ProductIdSchemeEnum productIdScheme) {
  ...
  public PublicPassportJsonLdExpanded digitalProductPassportId(@jakarta.annotation.Nonnull URI digitalProductPassportId) {
  ...
  public PublicPassportJsonLdExpanded uniqueProductIdentifier(@jakarta.annotation.Nonnull URI uniqueProductIdentifier) {
  ...
  public PublicPassportJsonLdExpanded granularity(@jakarta.annotation.Nonnull GranularityEnum granularity) {
  ...
  public PublicPassportJsonLdExpanded dppSchemaVersion(@jakarta.annotation.Nonnull DppSchemaVersionEnum dppSchemaVersion) {
  ...
  public PublicPassportJsonLdExpanded dppStatus(@jakarta.annotation.Nonnull String dppStatus) {
  ...
  public PublicPassportJsonLdExpanded lastUpdated(@jakarta.annotation.Nonnull OffsetDateTime lastUpdated) {
  ...
  public PublicPassportJsonLdExpanded economicOperatorId(@jakarta.annotation.Nonnull String economicOperatorId) {
  ...
  public PublicPassportJsonLdExpanded facilityId(@jakarta.annotation.Nullable URI facilityId) {
  ...
  public PublicPassportJsonLdExpanded contentSpecificationIds(@jakarta.annotation.Nullable List<URI> contentSpecificationIds) {
    this.contentSpecificationIds = contentSpecificationIds;
    return this;
  }

  public PublicPassportJsonLdExpanded addContentSpecificationIdsItem(URI contentSpecificationIdsItem) {
  ...
  public PublicPassportJsonLdExpanded digitalSeal(@jakarta.annotation.Nullable String digitalSeal) {
  ...
  public PublicPassportJsonLdExpanded signingPublicKey(@jakarta.annotation.Nullable String signingPublicKey) {
  ...
  public PublicPassportJsonLdExpanded status(@jakarta.annotation.Nonnull StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public PublicPassportJsonLdExpanded archivedAt(@jakarta.annotation.Nullable OffsetDateTime archivedAt) {
  ...
  public PublicPassportJsonLdExpanded retentionUntil(@jakarta.annotation.Nullable OffsetDateTime retentionUntil) {
  ...
  public PublicPassportJsonLdExpanded proof(@jakarta.annotation.Nullable MerkleTreeAttestationProof proof) {
    this.proof = proof;
    return this;
  }
  ...
  public PublicPassportJsonLdExpanded elements(@jakarta.annotation.Nonnull List<En18223DataElement> elements) {
    this.elements = elements;
    return this;
  }

  public PublicPassportJsonLdExpanded addElementsItem(En18223DataElement elementsItem) {
  ...
  @JsonProperty(JSON_PROPERTY_ELEMENTS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setElements(@jakarta.annotation.Nonnull List<En18223DataElement> elements) {
    this.elements = elements;
  }


  /**
   * Return true if this PublicPassportJsonLdExpanded object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PublicPassportJsonLdExpanded publicPassportJsonLdExpanded = (PublicPassportJsonLdExpanded) o;
    return Objects.equals(this.atContext, publicPassportJsonLdExpanded.atContext) &&
        Objects.equals(this.atType, publicPassportJsonLdExpanded.atType) &&
        Objects.equals(this.atId, publicPassportJsonLdExpanded.atId) &&
        Objects.equals(this.id, publicPassportJsonLdExpanded.id) &&
        Objects.equals(this.productId, publicPassportJsonLdExpanded.productId) &&
        Objects.equals(this.digitalLinkUri, publicPassportJsonLdExpanded.digitalLinkUri) &&
        Objects.equals(this.productIdScheme, publicPassportJsonLdExpanded.productIdScheme) &&
        Objects.equals(this.digitalProductPassportId, publicPassportJsonLdExpanded.digitalProductPassportId) &&
        Objects.equals(this.uniqueProductIdentifier, publicPassportJsonLdExpanded.uniqueProductIdentifier) &&
        Objects.equals(this.granularity, publicPassportJsonLdExpanded.granularity) &&
        Objects.equals(this.dppSchemaVersion, publicPassportJsonLdExpanded.dppSchemaVersion) &&
        Objects.equals(this.dppStatus, publicPassportJsonLdExpanded.dppStatus) &&
        Objects.equals(this.lastUpdated, publicPassportJsonLdExpanded.lastUpdated) &&
        Objects.equals(this.economicOperatorId, publicPassportJsonLdExpanded.economicOperatorId) &&
        Objects.equals(this.facilityId, publicPassportJsonLdExpanded.facilityId) &&
        Objects.equals(this.contentSpecificationIds, publicPassportJsonLdExpanded.contentSpecificationIds) &&
        Objects.equals(this.digitalSeal, publicPassportJsonLdExpanded.digitalSeal) &&
        Objects.equals(this.signingPublicKey, publicPassportJsonLdExpanded.signingPublicKey) &&
        Objects.equals(this.status, publicPassportJsonLdExpanded.status) &&
        Objects.equals(this.archivedAt, publicPassportJsonLdExpanded.archivedAt) &&
        Objects.equals(this.retentionUntil, publicPassportJsonLdExpanded.retentionUntil) &&
        Objects.equals(this.proof, publicPassportJsonLdExpanded.proof) &&
        Objects.equals(this.elements, publicPassportJsonLdExpanded.elements);
  }
  ...
  public String toString() {
    ...
    sb.append("class PublicPassportJsonLdExpanded {\n");
