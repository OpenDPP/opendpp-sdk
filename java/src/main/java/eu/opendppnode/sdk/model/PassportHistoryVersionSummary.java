...
/**
 * PassportHistoryVersionSummary
 */
@JsonPropertyOrder({
  PassportHistoryVersionSummary.JSON_PROPERTY_VERSION,
  PassportHistoryVersionSummary.JSON_PROPERTY_VALID_UNTIL,
  PassportHistoryVersionSummary.JSON_PROPERTY_RECORDED_AT,
  PassportHistoryVersionSummary.JSON_PROPERTY_CHANGED_BY,
  PassportHistoryVersionSummary.JSON_PROPERTY_CHANGE_REASON
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class PassportHistoryVersionSummary {
  ...
  public PassportHistoryVersionSummary() { 
  }

  public PassportHistoryVersionSummary version(@jakarta.annotation.Nonnull Integer version) {
  ...
  public PassportHistoryVersionSummary validUntil(@jakarta.annotation.Nonnull OffsetDateTime validUntil) {
  ...
  @JsonProperty(JSON_PROPERTY_VALID_UNTIL)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setValidUntil(@jakarta.annotation.Nonnull OffsetDateTime validUntil) {
    this.validUntil = validUntil;
  }


  public PassportHistoryVersionSummary recordedAt(@jakarta.annotation.Nonnull OffsetDateTime recordedAt) {
  ...
  public PassportHistoryVersionSummary changedBy(@jakarta.annotation.Nonnull String changedBy) {
  ...
  @JsonProperty(JSON_PROPERTY_CHANGED_BY)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setChangedBy(@jakarta.annotation.Nonnull String changedBy) {
    this.changedBy = changedBy;
  }


  public PassportHistoryVersionSummary changeReason(@jakarta.annotation.Nullable String changeReason) {
  ...
  /**
   * Return true if this PassportHistoryVersionSummary object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PassportHistoryVersionSummary passportHistoryVersionSummary = (PassportHistoryVersionSummary) o;
    return Objects.equals(this.version, passportHistoryVersionSummary.version) &&
        Objects.equals(this.validUntil, passportHistoryVersionSummary.validUntil) &&
        Objects.equals(this.recordedAt, passportHistoryVersionSummary.recordedAt) &&
        Objects.equals(this.changedBy, passportHistoryVersionSummary.changedBy) &&
        Objects.equals(this.changeReason, passportHistoryVersionSummary.changeReason);
  }

  @Override
  public int hashCode() {
    return Objects.hash(version, validUntil, recordedAt, changedBy, changeReason);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PassportHistoryVersionSummary {\n");
