...
/**
 * MintGtinCheckDigitRequest
 */
@JsonPropertyOrder({
  MintGtinCheckDigitRequest.JSON_PROPERTY_GS1_COMPANY_PREFIX,
  MintGtinCheckDigitRequest.JSON_PROPERTY_ITEM_REF
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class MintGtinCheckDigitRequest {
  ...
  public MintGtinCheckDigitRequest() { 
  }

  public MintGtinCheckDigitRequest gs1CompanyPrefix(@jakarta.annotation.Nonnull String gs1CompanyPrefix) {
  ...
  public MintGtinCheckDigitRequest itemRef(@jakarta.annotation.Nullable String itemRef) {
  ...
  @JsonProperty(JSON_PROPERTY_ITEM_REF)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setItemRef(@jakarta.annotation.Nullable String itemRef) {
    this.itemRef = itemRef;
  }


  /**
   * Return true if this mintGtinCheckDigit_request object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    MintGtinCheckDigitRequest mintGtinCheckDigitRequest = (MintGtinCheckDigitRequest) o;
    return Objects.equals(this.gs1CompanyPrefix, mintGtinCheckDigitRequest.gs1CompanyPrefix) &&
        Objects.equals(this.itemRef, mintGtinCheckDigitRequest.itemRef);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gs1CompanyPrefix, itemRef);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MintGtinCheckDigitRequest {\n");
