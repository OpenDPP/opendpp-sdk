...
@JsonPropertyOrder({
  ...
  MerkleTreeAttestationProof.JSON_PROPERTY_SEALED_KEYS,
...
public class MerkleTreeAttestationProof {
  ...
  public static final String JSON_PROPERTY_SEALED_KEYS = "sealedKeys";
  @jakarta.annotation.Nonnull
  private List<String> sealedKeys = new ArrayList<>();
  ...
  public MerkleTreeAttestationProof sealedKeys(@jakarta.annotation.Nonnull List<String> sealedKeys) {
    this.sealedKeys = sealedKeys;
    return this;
  }

  public MerkleTreeAttestationProof addSealedKeysItem(String sealedKeysItem) {
    if (this.sealedKeys == null) {
      this.sealedKeys = new ArrayList<>();
    }
    this.sealedKeys.add(sealedKeysItem);
    return this;
  }
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(JSON_PROPERTY_SEALED_KEYS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public List<String> getSealedKeys() {
    return sealedKeys;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SEALED_KEYS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setSealedKeys(@jakarta.annotation.Nonnull List<String> sealedKeys) {
    this.sealedKeys = sealedKeys;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.atType, merkleTreeAttestationProof.atType) &&
        ...
        Objects.equals(this.sealedKeys, merkleTreeAttestationProof.sealedKeys) &&
        Objects.equals(this.redactedLeaves, merkleTreeAttestationProof.redactedLeaves);
  }

  @Override
  public int hashCode() {
    return Objects.hash(atType, type, signatureAlgorithm, created, proofPurpose, verificationMethod, signatureValue, publicKeyPem, x5c, rfc3161, merkleRoot, sealedKeys, redactedLeaves);
  }
  ...
  public String toString() {
    ...
    sb.append("    sealedKeys: ").append(toIndentedString(sealedKeys)).append("\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `sealedKeys` to the URL query string
    if (getSealedKeys() != null) {
      for (int i = 0; i < getSealedKeys().size(); i++) {
        joiner.add(String.format("%ssealedKeys%s%s=%s", prefix, suffix,
            "".equals(suffix) ? "" : String.format("%s%d%s", containerPrefix, i, containerSuffix),
            ApiClient.urlEncode(ApiClient.valueToString(getSealedKeys().get(i)))));
      }
    }
