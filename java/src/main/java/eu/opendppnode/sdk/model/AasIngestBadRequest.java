...
import eu.opendppnode.sdk.model.AasIngestValidationError;
...
@JsonDeserialize(using=AasIngestBadRequest.AasIngestBadRequestDeserializer.class)
@JsonSerialize(using = AasIngestBadRequest.AasIngestBadRequestSerializer.class)
public class AasIngestBadRequest extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(AasIngestBadRequest.class.getName());

    public static class AasIngestBadRequestSerializer extends StdSerializer<AasIngestBadRequest> {
        public AasIngestBadRequestSerializer(Class<AasIngestBadRequest> t) {
            super(t);
        }

        public AasIngestBadRequestSerializer() {
            this(null);
        }

        @Override
        public void serialize(AasIngestBadRequest value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class AasIngestBadRequestDeserializer extends StdDeserializer<AasIngestBadRequest> {
        public AasIngestBadRequestDeserializer() {
            this(AasIngestBadRequest.class);
        }

        public AasIngestBadRequestDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public AasIngestBadRequest deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            JsonNode tree = jp.readValueAsTree();

            Object deserialized = null;
            // deserialize AasIngestValidationError
            try {
                deserialized = tree.traverse(jp.getCodec()).readValueAs(AasIngestValidationError.class);
                AasIngestBadRequest ret = new AasIngestBadRequest();
                ret.setActualInstance(deserialized);
                return ret;
            } catch (Exception e) {
                // deserialization failed, continue, log to help debugging
                log.log(Level.FINER, "Input data does not match 'AasIngestBadRequest'", e);
            }
            ...
            throw new IOException(String.format("Failed deserialization for AasIngestBadRequest: no match found"));
        }
         ...
         */
        @Override
        public AasIngestBadRequest getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "AasIngestBadRequest cannot be null");
        }
    }
    ...
    public AasIngestBadRequest() {
        super("anyOf", Boolean.FALSE);
    }

    public AasIngestBadRequest(AasIngestValidationError o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public AasIngestBadRequest(Error o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("AasIngestValidationError", AasIngestValidationError.class);
        schemas.put("Error", Error.class);
        JSON.registerDescendants(AasIngestBadRequest.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return AasIngestBadRequest.schemas;
    }

    /**
     * Set the instance that matches the anyOf child schema, check
     * the instance parameter is valid against the anyOf child schemas:
     * AasIngestValidationError, Error
     *
    ...
    public void setActualInstance(Object instance) {
        if (JSON.isInstanceOf(AasIngestValidationError.class, instance, new HashSet<Class<?>>())) {
        ...
        throw new RuntimeException("Invalid instance type. Must be AasIngestValidationError, Error");
    }
     ...
     * AasIngestValidationError, Error
     *
     * @return The actual instance (AasIngestValidationError, Error)
     */
    @Override
    ...
    /**
     * Get the actual instance of `AasIngestValidationError`. If the actual instance is not `AasIngestValidationError`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `AasIngestValidationError`
     * @throws ClassCastException if the instance is not `AasIngestValidationError`
     */
    public AasIngestValidationError getAasIngestValidationError() throws ClassCastException {
        return (AasIngestValidationError)super.getActualInstance();
    }
