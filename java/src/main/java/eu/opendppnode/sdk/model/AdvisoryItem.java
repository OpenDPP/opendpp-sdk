...
public class AdvisoryItem {
  ...
  public enum CodeEnum {
    ...
    CARRIER_SYMBOLOGY_NOT_RENDERED(String.valueOf("CARRIER_SYMBOLOGY_NOT_RENDERED")),
    
    CATEGORY_GRANULARITY_UNEXPECTED(String.valueOf("CATEGORY_GRANULARITY_UNEXPECTED")),
