...
import eu.opendppnode.sdk.model.ForwardedResolverRateLimitError;
import eu.opendppnode.sdk.model.GlobalRateLimitError;
...
@JsonDeserialize(using=PassportGetTooManyRequests.PassportGetTooManyRequestsDeserializer.class)
@JsonSerialize(using = PassportGetTooManyRequests.PassportGetTooManyRequestsSerializer.class)
public class PassportGetTooManyRequests extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(PassportGetTooManyRequests.class.getName());

    public static class PassportGetTooManyRequestsSerializer extends StdSerializer<PassportGetTooManyRequests> {
        public PassportGetTooManyRequestsSerializer(Class<PassportGetTooManyRequests> t) {
            super(t);
        }

        public PassportGetTooManyRequestsSerializer() {
            this(null);
        }

        @Override
        public void serialize(PassportGetTooManyRequests value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class PassportGetTooManyRequestsDeserializer extends StdDeserializer<PassportGetTooManyRequests> {
        public PassportGetTooManyRequestsDeserializer() {
            this(PassportGetTooManyRequests.class);
        }

        public PassportGetTooManyRequestsDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public PassportGetTooManyRequests deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            JsonNode tree = jp.readValueAsTree();

            Object deserialized = null;
            // deserialize ForwardedResolverRateLimitError
            try {
                deserialized = tree.traverse(jp.getCodec()).readValueAs(ForwardedResolverRateLimitError.class);
                PassportGetTooManyRequests ret = new PassportGetTooManyRequests();
                ret.setActualInstance(deserialized);
                return ret;
            } catch (Exception e) {
                // deserialization failed, continue, log to help debugging
                log.log(Level.FINER, "Input data does not match 'PassportGetTooManyRequests'", e);
            }

            // deserialize GlobalRateLimitError
            try {
                deserialized = tree.traverse(jp.getCodec()).readValueAs(GlobalRateLimitError.class);
                PassportGetTooManyRequests ret = new PassportGetTooManyRequests();
                ret.setActualInstance(deserialized);
                return ret;
            } catch (Exception e) {
            ...
            throw new IOException(String.format("Failed deserialization for PassportGetTooManyRequests: no match found"));
        }
         ...
         */
        @Override
        public PassportGetTooManyRequests getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "PassportGetTooManyRequests cannot be null");
        }
    }
    ...
    public PassportGetTooManyRequests() {
        super("anyOf", Boolean.FALSE);
    }

    public PassportGetTooManyRequests(ForwardedResolverRateLimitError o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public PassportGetTooManyRequests(GlobalRateLimitError o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("ForwardedResolverRateLimitError", ForwardedResolverRateLimitError.class);
        schemas.put("GlobalRateLimitError", GlobalRateLimitError.class);
        JSON.registerDescendants(PassportGetTooManyRequests.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return PassportGetTooManyRequests.schemas;
    }

    /**
     * Set the instance that matches the anyOf child schema, check
     * the instance parameter is valid against the anyOf child schemas:
     * ForwardedResolverRateLimitError, GlobalRateLimitError
     *
    ...
    public void setActualInstance(Object instance) {
        if (JSON.isInstanceOf(ForwardedResolverRateLimitError.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }

        if (JSON.isInstanceOf(GlobalRateLimitError.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be ForwardedResolverRateLimitError, GlobalRateLimitError");
    }
     ...
     * ForwardedResolverRateLimitError, GlobalRateLimitError
     *
     * @return The actual instance (ForwardedResolverRateLimitError, GlobalRateLimitError)
     */
    @Override
    ...
    /**
     * Get the actual instance of `ForwardedResolverRateLimitError`. If the actual instance is not `ForwardedResolverRateLimitError`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `ForwardedResolverRateLimitError`
     * @throws ClassCastException if the instance is not `ForwardedResolverRateLimitError`
     */
    public ForwardedResolverRateLimitError getForwardedResolverRateLimitError() throws ClassCastException {
        return (ForwardedResolverRateLimitError)super.getActualInstance();
    }

    /**
     * Get the actual instance of `GlobalRateLimitError`. If the actual instance is not `GlobalRateLimitError`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `GlobalRateLimitError`
     * @throws ClassCastException if the instance is not `GlobalRateLimitError`
     */
    public GlobalRateLimitError getGlobalRateLimitError() throws ClassCastException {
        return (GlobalRateLimitError)super.getActualInstance();
    }
