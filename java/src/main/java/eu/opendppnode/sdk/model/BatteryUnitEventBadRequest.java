...
@JsonDeserialize(using = BatteryUnitEventBadRequest.BatteryUnitEventBadRequestDeserializer.class)
@JsonSerialize(using = BatteryUnitEventBadRequest.BatteryUnitEventBadRequestSerializer.class)
public class BatteryUnitEventBadRequest extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(BatteryUnitEventBadRequest.class.getName());

    public static class BatteryUnitEventBadRequestSerializer extends StdSerializer<BatteryUnitEventBadRequest> {
        public BatteryUnitEventBadRequestSerializer(Class<BatteryUnitEventBadRequest> t) {
            super(t);
        }

        public BatteryUnitEventBadRequestSerializer() {
            this(null);
        }

        @Override
        public void serialize(BatteryUnitEventBadRequest value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class BatteryUnitEventBadRequestDeserializer extends StdDeserializer<BatteryUnitEventBadRequest> {
        public BatteryUnitEventBadRequestDeserializer() {
            this(BatteryUnitEventBadRequest.class);
        }

        public BatteryUnitEventBadRequestDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public BatteryUnitEventBadRequest deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                BatteryUnitEventBadRequest ret = new BatteryUnitEventBadRequest();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format("Failed deserialization for BatteryUnitEventBadRequest: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public BatteryUnitEventBadRequest getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "BatteryUnitEventBadRequest cannot be null");
        }
    }
    ...
    public BatteryUnitEventBadRequest() {
        super("oneOf", Boolean.FALSE);
    }

    public BatteryUnitEventBadRequest(DefaultRequestRejectionError o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public BatteryUnitEventBadRequest(Error o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(BatteryUnitEventBadRequest.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return BatteryUnitEventBadRequest.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * DefaultRequestRejectionError, Error
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be DefaultRequestRejectionError, Error");
    }
     ...
     * DefaultRequestRejectionError, Error
     *
     * @return The actual instance (DefaultRequestRejectionError, Error)
     */
    @Override
