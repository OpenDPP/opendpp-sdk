 ...
 */
@JsonPropertyOrder({
  FacilityEnvelope.JSON_PROPERTY_SUCCESS,
  FacilityEnvelope.JSON_PROPERTY_FACILITY
})
...
public class FacilityEnvelope {
  ...
  public FacilityEnvelope facility(@jakarta.annotation.Nonnull FacilityRow facility) {
  ...
  /**
   * Return true if this FacilityEnvelope object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    FacilityEnvelope facilityEnvelope = (FacilityEnvelope) o;
    return Objects.equals(this.success, facilityEnvelope.success) &&
        Objects.equals(this.facility, facilityEnvelope.facility);
  }

  @Override
  public int hashCode() {
    return Objects.hash(success, facility);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FacilityEnvelope {\n");
