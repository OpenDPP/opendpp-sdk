...
public enum BatteryUnitStatus {
  ...
  BatteryUnitStatus(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static BatteryUnitStatus fromValue(String value) {
    for (BatteryUnitStatus b : BatteryUnitStatus.values()) {
