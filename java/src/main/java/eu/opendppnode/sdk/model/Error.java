...
public class Error {
  ...
  public enum CodeEnum {
    ...
    UNSUPPORTED_KEY_QUALIFIER(String.valueOf("UNSUPPORTED_KEY_QUALIFIER")),
    
    UNSUPPORTED_REPRESENTATION(String.valueOf("UNSUPPORTED_REPRESENTATION")),
    ...
    DRAFT_DEMOTION_REFUSED(String.valueOf("DRAFT_DEMOTION_REFUSED")),
