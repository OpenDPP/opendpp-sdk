...
@JsonDeserialize(using=GrantRevokeForbidden.GrantRevokeForbiddenDeserializer.class)
@JsonSerialize(using = GrantRevokeForbidden.GrantRevokeForbiddenSerializer.class)
public class GrantRevokeForbidden extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GrantRevokeForbidden.class.getName());

    public static class GrantRevokeForbiddenSerializer extends StdSerializer<GrantRevokeForbidden> {
        public GrantRevokeForbiddenSerializer(Class<GrantRevokeForbidden> t) {
            super(t);
        }

        public GrantRevokeForbiddenSerializer() {
            this(null);
        }

        @Override
        public void serialize(GrantRevokeForbidden value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class GrantRevokeForbiddenDeserializer extends StdDeserializer<GrantRevokeForbidden> {
        public GrantRevokeForbiddenDeserializer() {
            this(GrantRevokeForbidden.class);
        }

        public GrantRevokeForbiddenDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public GrantRevokeForbidden deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                GrantRevokeForbidden ret = new GrantRevokeForbidden();
                ret.setActualInstance(deserialized);
                return ret;
            } catch (Exception e) {
                // deserialization failed, continue, log to help debugging
                log.log(Level.FINER, "Input data does not match 'GrantRevokeForbidden'", e);
            }
            ...
            throw new IOException(String.format("Failed deserialization for GrantRevokeForbidden: no match found"));
        }
         ...
         */
        @Override
        public GrantRevokeForbidden getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "GrantRevokeForbidden cannot be null");
        }
    }
    ...
    public GrantRevokeForbidden() {
        super("anyOf", Boolean.FALSE);
    }

    public GrantRevokeForbidden(Error o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GrantRevokeForbidden(GrantRouteError o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(GrantRevokeForbidden.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return GrantRevokeForbidden.schemas;
    }
