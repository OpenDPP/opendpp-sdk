 ...
 */
@JsonPropertyOrder({
  PassportValidateOnlyRequest.JSON_PROPERTY_PRODUCT_ID,
  PassportValidateOnlyRequest.JSON_PROPERTY_OPERATOR_ID,
  PassportValidateOnlyRequest.JSON_PROPERTY_METADATA,
  PassportValidateOnlyRequest.JSON_PROPERTY_CARRIER
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class PassportValidateOnlyRequest {
  ...
  public PassportValidateOnlyRequest() { 
  }

  public PassportValidateOnlyRequest productId(@jakarta.annotation.Nonnull String productId) {
  ...
  public PassportValidateOnlyRequest operatorId(@jakarta.annotation.Nullable String operatorId) {
  ...
  public PassportValidateOnlyRequest metadata(@jakarta.annotation.Nonnull PassportMetadataInput metadata) {
  ...
  public PassportValidateOnlyRequest carrier(@jakarta.annotation.Nullable CarrierDeclaration carrier) {
  ...
  /**
   * Return true if this PassportValidateOnlyRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PassportValidateOnlyRequest passportValidateOnlyRequest = (PassportValidateOnlyRequest) o;
    return Objects.equals(this.productId, passportValidateOnlyRequest.productId) &&
        Objects.equals(this.operatorId, passportValidateOnlyRequest.operatorId) &&
        Objects.equals(this.metadata, passportValidateOnlyRequest.metadata) &&
        Objects.equals(this.carrier, passportValidateOnlyRequest.carrier);
  }

  @Override
  public int hashCode() {
    return Objects.hash(productId, operatorId, metadata, carrier);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PassportValidateOnlyRequest {\n");
