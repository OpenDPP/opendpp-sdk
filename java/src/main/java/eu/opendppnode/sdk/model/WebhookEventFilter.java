 ...
 */
public enum WebhookEventFilter {
  
  PASSPORT_INGESTED("passport.ingested"),
  
  PASSPORT_UPDATED("passport.updated"),
  
  PASSPORT_SEALED("passport.sealed"),
  
  PASSPORT_RECALLED("passport.recalled"),
  ...
  WebhookEventFilter(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static WebhookEventFilter fromValue(String value) {
    for (WebhookEventFilter b : WebhookEventFilter.values()) {
