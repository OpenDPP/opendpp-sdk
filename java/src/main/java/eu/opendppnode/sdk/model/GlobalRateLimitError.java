 ...
 */
@JsonPropertyOrder({
  GlobalRateLimitError.JSON_PROPERTY_STATUS_CODE,
  GlobalRateLimitError.JSON_PROPERTY_ERROR,
  GlobalRateLimitError.JSON_PROPERTY_MESSAGE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class GlobalRateLimitError {
  ...
  public GlobalRateLimitError() { 
  }

  public GlobalRateLimitError statusCode(@jakarta.annotation.Nonnull Integer statusCode) {
  ...
  public GlobalRateLimitError error(@jakarta.annotation.Nonnull String error) {
    this.error = error;
    return this;
  }
  ...
  public GlobalRateLimitError message(@jakarta.annotation.Nonnull String message) {
  ...
  /**
   * Return true if this GlobalRateLimitError object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GlobalRateLimitError globalRateLimitError = (GlobalRateLimitError) o;
    return Objects.equals(this.statusCode, globalRateLimitError.statusCode) &&
        Objects.equals(this.error, globalRateLimitError.error) &&
        Objects.equals(this.message, globalRateLimitError.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class GlobalRateLimitError {\n");
