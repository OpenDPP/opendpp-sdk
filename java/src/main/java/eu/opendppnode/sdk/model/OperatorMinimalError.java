 ...
 */
@JsonPropertyOrder({
  OperatorMinimalError.JSON_PROPERTY_SUCCESS,
  OperatorMinimalError.JSON_PROPERTY_MESSAGE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class OperatorMinimalError {
  /**
  ...
  public OperatorMinimalError() { 
  }

  public OperatorMinimalError success(@jakarta.annotation.Nonnull SuccessEnum success) {
  ...
  public OperatorMinimalError message(@jakarta.annotation.Nonnull String message) {
  ...
  /**
   * Return true if this OperatorMinimalError object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    OperatorMinimalError operatorMinimalError = (OperatorMinimalError) o;
    return Objects.equals(this.success, operatorMinimalError.success) &&
        Objects.equals(this.message, operatorMinimalError.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class OperatorMinimalError {\n");
