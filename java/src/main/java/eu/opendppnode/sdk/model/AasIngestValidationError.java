 ...
 */
@JsonPropertyOrder({
  AasIngestValidationError.JSON_PROPERTY_SUCCESS,
  AasIngestValidationError.JSON_PROPERTY_ERROR,
  AasIngestValidationError.JSON_PROPERTY_MESSAGE,
  AasIngestValidationError.JSON_PROPERTY_ERRORS,
  AasIngestValidationError.JSON_PROPERTY_WARNINGS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class AasIngestValidationError {
  ...
  public AasIngestValidationError() { 
  }

  public AasIngestValidationError success(@jakarta.annotation.Nonnull Boolean success) {
  ...
  public AasIngestValidationError error(@jakarta.annotation.Nonnull ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public AasIngestValidationError message(@jakarta.annotation.Nonnull String message) {
  ...
  public AasIngestValidationError errors(@jakarta.annotation.Nonnull List<ValidationErrorItem> errors) {
    this.errors = errors;
    return this;
  }

  public AasIngestValidationError addErrorsItem(ValidationErrorItem errorsItem) {
    if (this.errors == null) {
  ...
  public AasIngestValidationError warnings(@jakarta.annotation.Nullable List<ValidationErrorItem> warnings) {
    this.warnings = warnings;
    return this;
  }

  public AasIngestValidationError addWarningsItem(ValidationErrorItem warningsItem) {
  ...
  /**
   * Return true if this AasIngestValidationError object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    AasIngestValidationError aasIngestValidationError = (AasIngestValidationError) o;
    return Objects.equals(this.success, aasIngestValidationError.success) &&
        Objects.equals(this.error, aasIngestValidationError.error) &&
        Objects.equals(this.message, aasIngestValidationError.message) &&
        Objects.equals(this.errors, aasIngestValidationError.errors) &&
        Objects.equals(this.warnings, aasIngestValidationError.warnings);
  }
  ...
  public String toString() {
    ...
    sb.append("class AasIngestValidationError {\n");
