 ...
 */
@JsonPropertyOrder({
  DefaultRequestRejectionError.JSON_PROPERTY_STATUS_CODE,
  DefaultRequestRejectionError.JSON_PROPERTY_CODE,
  DefaultRequestRejectionError.JSON_PROPERTY_ERROR,
  DefaultRequestRejectionError.JSON_PROPERTY_MESSAGE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class DefaultRequestRejectionError {
  /**
  ...
  public DefaultRequestRejectionError() { 
  }

  public DefaultRequestRejectionError statusCode(@jakarta.annotation.Nonnull StatusCodeEnum statusCode) {
  ...
  public DefaultRequestRejectionError code(@jakarta.annotation.Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public DefaultRequestRejectionError error(@jakarta.annotation.Nonnull ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public DefaultRequestRejectionError message(@jakarta.annotation.Nonnull String message) {
  ...
  /**
   * Return true if this DefaultRequestRejectionError object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DefaultRequestRejectionError defaultRequestRejectionError = (DefaultRequestRejectionError) o;
    return Objects.equals(this.statusCode, defaultRequestRejectionError.statusCode) &&
        Objects.equals(this.code, defaultRequestRejectionError.code) &&
        Objects.equals(this.error, defaultRequestRejectionError.error) &&
        Objects.equals(this.message, defaultRequestRejectionError.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class DefaultRequestRejectionError {\n");
