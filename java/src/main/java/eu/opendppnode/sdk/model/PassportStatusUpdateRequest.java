 ...
 */
@JsonPropertyOrder({
  PassportStatusUpdateRequest.JSON_PROPERTY_STATUS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class PassportStatusUpdateRequest {
  /**
  ...
  public PassportStatusUpdateRequest() { 
  }

  public PassportStatusUpdateRequest status(@jakarta.annotation.Nonnull StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  /**
   * Return true if this PassportStatusUpdateRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PassportStatusUpdateRequest passportStatusUpdateRequest = (PassportStatusUpdateRequest) o;
    return Objects.equals(this.status, passportStatusUpdateRequest.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class PassportStatusUpdateRequest {\n");
