...
import eu.opendppnode.sdk.model.PassportCreateValidationError;
...
@JsonDeserialize(using=PassportCreateBadRequest.PassportCreateBadRequestDeserializer.class)
@JsonSerialize(using = PassportCreateBadRequest.PassportCreateBadRequestSerializer.class)
public class PassportCreateBadRequest extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(PassportCreateBadRequest.class.getName());

    public static class PassportCreateBadRequestSerializer extends StdSerializer<PassportCreateBadRequest> {
        public PassportCreateBadRequestSerializer(Class<PassportCreateBadRequest> t) {
            super(t);
        }

        public PassportCreateBadRequestSerializer() {
            this(null);
        }

        @Override
        public void serialize(PassportCreateBadRequest value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class PassportCreateBadRequestDeserializer extends StdDeserializer<PassportCreateBadRequest> {
        public PassportCreateBadRequestDeserializer() {
            this(PassportCreateBadRequest.class);
        }

        public PassportCreateBadRequestDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public PassportCreateBadRequest deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                PassportCreateBadRequest ret = new PassportCreateBadRequest();
                ret.setActualInstance(deserialized);
                return ret;
            } catch (Exception e) {
                // deserialization failed, continue, log to help debugging
                log.log(Level.FINER, "Input data does not match 'PassportCreateBadRequest'", e);
            }

            // deserialize PassportCreateValidationError
            try {
                deserialized = tree.traverse(jp.getCodec()).readValueAs(PassportCreateValidationError.class);
                PassportCreateBadRequest ret = new PassportCreateBadRequest();
                ret.setActualInstance(deserialized);
                return ret;
            } catch (Exception e) {
            ...
            throw new IOException(String.format("Failed deserialization for PassportCreateBadRequest: no match found"));
        }
         ...
         */
        @Override
        public PassportCreateBadRequest getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "PassportCreateBadRequest cannot be null");
        }
    }
    ...
    public PassportCreateBadRequest() {
        super("anyOf", Boolean.FALSE);
    }

    public PassportCreateBadRequest(Error o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public PassportCreateBadRequest(PassportCreateValidationError o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        schemas.put("PassportCreateValidationError", PassportCreateValidationError.class);
        JSON.registerDescendants(PassportCreateBadRequest.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return PassportCreateBadRequest.schemas;
    }

    /**
     * Set the instance that matches the anyOf child schema, check
     * the instance parameter is valid against the anyOf child schemas:
     * Error, PassportCreateValidationError
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        if (JSON.isInstanceOf(PassportCreateValidationError.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be Error, PassportCreateValidationError");
    }
     ...
     * Error, PassportCreateValidationError
     *
     * @return The actual instance (Error, PassportCreateValidationError)
     */
    @Override
    ...
    /**
     * Get the actual instance of `PassportCreateValidationError`. If the actual instance is not `PassportCreateValidationError`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `PassportCreateValidationError`
     * @throws ClassCastException if the instance is not `PassportCreateValidationError`
     */
    public PassportCreateValidationError getPassportCreateValidationError() throws ClassCastException {
        return (PassportCreateValidationError)super.getActualInstance();
    }
