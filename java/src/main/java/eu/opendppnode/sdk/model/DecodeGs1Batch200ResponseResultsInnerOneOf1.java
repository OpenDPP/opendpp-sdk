 ...
 */
@JsonPropertyOrder({
  DecodeGs1Batch200ResponseResultsInnerOneOf1.JSON_PROPERTY_OK,
...
public class DecodeGs1Batch200ResponseResultsInnerOneOf1 extends HashMap<String, Object> {
  ...
  public DecodeGs1Batch200ResponseResultsInnerOneOf1 error(@jakarta.annotation.Nonnull String error) {
    this.error = error;
    return this;
  }
