 ...
 */
@JsonPropertyOrder({
  WebhookSubscriptionDeleteResponse.JSON_PROPERTY_SUCCESS,
  WebhookSubscriptionDeleteResponse.JSON_PROPERTY_MESSAGE
})
...
public class WebhookSubscriptionDeleteResponse {
  ...
  public WebhookSubscriptionDeleteResponse() { 
  }

  public WebhookSubscriptionDeleteResponse success(@jakarta.annotation.Nonnull SuccessEnum success) {
  ...
  public WebhookSubscriptionDeleteResponse message(@jakarta.annotation.Nonnull MessageEnum message) {
  ...
  /**
   * Return true if this WebhookSubscriptionDeleteResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    WebhookSubscriptionDeleteResponse webhookSubscriptionDeleteResponse = (WebhookSubscriptionDeleteResponse) o;
    return Objects.equals(this.success, webhookSubscriptionDeleteResponse.success) &&
        Objects.equals(this.message, webhookSubscriptionDeleteResponse.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookSubscriptionDeleteResponse {\n");
