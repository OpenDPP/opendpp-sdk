 ...
 */
@JsonPropertyOrder({
  InlineObject.JSON_PROPERTY_STATUS_CODE,
...
public class InlineObject {
  ...
  public InlineObject statusCode(@jakarta.annotation.Nonnull Integer statusCode) {
  ...
  public InlineObject code(@jakarta.annotation.Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public InlineObject error(@jakarta.annotation.Nonnull String error) {
    this.error = error;
    return this;
  }
  ...
  public InlineObject message(@jakarta.annotation.Nonnull String message) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.statusCode, inlineObject.statusCode) &&
