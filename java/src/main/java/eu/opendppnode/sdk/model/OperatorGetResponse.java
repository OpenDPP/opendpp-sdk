 ...
 */
@JsonPropertyOrder({
  OperatorGetResponse.JSON_PROPERTY_SUCCESS,
  OperatorGetResponse.JSON_PROPERTY_OPERATOR
})
...
public class OperatorGetResponse {
  ...
  public OperatorGetResponse() { 
  }

  public OperatorGetResponse success(@jakarta.annotation.Nonnull SuccessEnum success) {
  ...
  public OperatorGetResponse operator(@jakarta.annotation.Nonnull OperatorRow operator) {
  ...
  /**
   * Return true if this OperatorGetResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    OperatorGetResponse operatorGetResponse = (OperatorGetResponse) o;
    return Objects.equals(this.success, operatorGetResponse.success) &&
        Objects.equals(this.operator, operatorGetResponse.operator);
  }
  ...
  public String toString() {
    ...
    sb.append("class OperatorGetResponse {\n");
