...
@JsonDeserialize(using = RecordBatteryUnitEvent400Response.RecordBatteryUnitEvent400ResponseDeserializer.class)
@JsonSerialize(using = RecordBatteryUnitEvent400Response.RecordBatteryUnitEvent400ResponseSerializer.class)
public class RecordBatteryUnitEvent400Response extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(RecordBatteryUnitEvent400Response.class.getName());

    public static class RecordBatteryUnitEvent400ResponseSerializer extends StdSerializer<RecordBatteryUnitEvent400Response> {
        public RecordBatteryUnitEvent400ResponseSerializer(Class<RecordBatteryUnitEvent400Response> t) {
            super(t);
        }

        public RecordBatteryUnitEvent400ResponseSerializer() {
            this(null);
        }

        @Override
        public void serialize(RecordBatteryUnitEvent400Response value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class RecordBatteryUnitEvent400ResponseDeserializer extends StdDeserializer<RecordBatteryUnitEvent400Response> {
        public RecordBatteryUnitEvent400ResponseDeserializer() {
            this(RecordBatteryUnitEvent400Response.class);
        }

        public RecordBatteryUnitEvent400ResponseDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public RecordBatteryUnitEvent400Response deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                RecordBatteryUnitEvent400Response ret = new RecordBatteryUnitEvent400Response();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format("Failed deserialization for RecordBatteryUnitEvent400Response: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public RecordBatteryUnitEvent400Response getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "RecordBatteryUnitEvent400Response cannot be null");
        }
    }
    ...
    public RecordBatteryUnitEvent400Response() {
        super("oneOf", Boolean.FALSE);
    }

    public RecordBatteryUnitEvent400Response(Error o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public RecordBatteryUnitEvent400Response(FastifyDefaultBadRequest o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(RecordBatteryUnitEvent400Response.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return RecordBatteryUnitEvent400Response.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * Error, FastifyDefaultBadRequest
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be Error, FastifyDefaultBadRequest");
    }
     ...
     * Error, FastifyDefaultBadRequest
     *
     * @return The actual instance (Error, FastifyDefaultBadRequest)
     */
    @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getActualInstance() instanceof FastifyDefaultBadRequest) {
        if (getActualInstance() != null) {
          joiner.add(((FastifyDefaultBadRequest)getActualInstance()).toUrlQueryString(prefix + "one_of_1" + suffix));
        }
        return joiner.toString();
    }
    return null;
