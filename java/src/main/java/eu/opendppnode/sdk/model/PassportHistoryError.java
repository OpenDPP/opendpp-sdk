 ...
 */
@JsonPropertyOrder({
  PassportHistoryError.JSON_PROPERTY_SUCCESS,
  PassportHistoryError.JSON_PROPERTY_ERROR,
  PassportHistoryError.JSON_PROPERTY_MESSAGE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class PassportHistoryError {
  ...
  public PassportHistoryError() { 
  }

  public PassportHistoryError success(@jakarta.annotation.Nonnull Boolean success) {
  ...
  public PassportHistoryError error(@jakarta.annotation.Nonnull String error) {
    this.error = error;
    return this;
  }
  ...
  public PassportHistoryError message(@jakarta.annotation.Nonnull String message) {
  ...
  /**
   * Return true if this PassportHistoryError object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PassportHistoryError passportHistoryError = (PassportHistoryError) o;
    return Objects.equals(this.success, passportHistoryError.success) &&
        Objects.equals(this.error, passportHistoryError.error) &&
        Objects.equals(this.message, passportHistoryError.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class PassportHistoryError {\n");
