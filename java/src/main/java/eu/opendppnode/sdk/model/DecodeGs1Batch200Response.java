...
import eu.opendppnode.sdk.model.Gs1BatchDecodeResult;
...
public class DecodeGs1Batch200Response {
  ...
  @jakarta.annotation.Nonnull
  private List<Gs1BatchDecodeResult> results = new ArrayList<>();
  ...
  public DecodeGs1Batch200Response results(@jakarta.annotation.Nonnull List<Gs1BatchDecodeResult> results) {
    this.results = results;
    return this;
  }

  public DecodeGs1Batch200Response addResultsItem(Gs1BatchDecodeResult resultsItem) {
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public List<Gs1BatchDecodeResult> getResults() {
    return results;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RESULTS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setResults(@jakarta.annotation.Nonnull List<Gs1BatchDecodeResult> results) {
    this.results = results;
  }
