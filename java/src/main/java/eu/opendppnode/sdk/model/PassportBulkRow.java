...
@JsonPropertyOrder({
  ...
  PassportBulkRow.JSON_PROPERTY_CARRIER
})
...
public class PassportBulkRow {
  ...
  public PassportBulkRow carrier(@jakarta.annotation.Nullable CarrierDeclaration carrier) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.productId, passportBulkRow.productId) &&
        ...
        Objects.equals(this.carrier, passportBulkRow.carrier);
  }

  @Override
  public int hashCode() {
    return Objects.hash(productId, operatorId, facilityId, metadata, carrier);
  }
