 ...
 */
@JsonPropertyOrder({
  Gs1BatchDecodeError.JSON_PROPERTY_OK,
  Gs1BatchDecodeError.JSON_PROPERTY_ERROR
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
public class Gs1BatchDecodeError {
  ...
  public Gs1BatchDecodeError() { 
  }

  public Gs1BatchDecodeError ok(@jakarta.annotation.Nonnull Boolean ok) {
    this.ok = ok;
    return this;
  }
  ...
  public Gs1BatchDecodeError error(@jakarta.annotation.Nonnull String error) {
    this.error = error;
    return this;
  }
  ...
  /**
   * Return true if this Gs1BatchDecodeError object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    Gs1BatchDecodeError gs1BatchDecodeError = (Gs1BatchDecodeError) o;
    return Objects.equals(this.ok, gs1BatchDecodeError.ok) &&
        Objects.equals(this.error, gs1BatchDecodeError.error);
  }
  ...
  public String toString() {
    ...
    sb.append("class Gs1BatchDecodeError {\n");
