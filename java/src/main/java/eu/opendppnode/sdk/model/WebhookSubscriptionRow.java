 ...
 */
@JsonPropertyOrder({
  WebhookSubscriptionRow.JSON_PROPERTY_ID,
  WebhookSubscriptionRow.JSON_PROPERTY_TENANT_ID,
  WebhookSubscriptionRow.JSON_PROPERTY_URL,
  WebhookSubscriptionRow.JSON_PROPERTY_EVENTS,
  WebhookSubscriptionRow.JSON_PROPERTY_IS_ACTIVE,
  WebhookSubscriptionRow.JSON_PROPERTY_CREATED_AT,
  WebhookSubscriptionRow.JSON_PROPERTY_UPDATED_AT
})
...
public class WebhookSubscriptionRow {
  ...
  public WebhookSubscriptionRow() { 
  }

  public WebhookSubscriptionRow id(@jakarta.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public WebhookSubscriptionRow tenantId(@jakarta.annotation.Nonnull String tenantId) {
  ...
  public WebhookSubscriptionRow url(@jakarta.annotation.Nonnull URI url) {
    this.url = url;
    return this;
  }
  ...
  public WebhookSubscriptionRow events(@jakarta.annotation.Nonnull List<WebhookEventFilter> events) {
    this.events = events;
    return this;
  }

  public WebhookSubscriptionRow addEventsItem(WebhookEventFilter eventsItem) {
    if (this.events == null) {
  ...
  public WebhookSubscriptionRow isActive(@jakarta.annotation.Nonnull Boolean isActive) {
  ...
  public WebhookSubscriptionRow createdAt(@jakarta.annotation.Nonnull OffsetDateTime createdAt) {
  ...
  public WebhookSubscriptionRow updatedAt(@jakarta.annotation.Nonnull OffsetDateTime updatedAt) {
  ...
  /**
   * Return true if this WebhookSubscriptionRow object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    WebhookSubscriptionRow webhookSubscriptionRow = (WebhookSubscriptionRow) o;
    return Objects.equals(this.id, webhookSubscriptionRow.id) &&
        Objects.equals(this.tenantId, webhookSubscriptionRow.tenantId) &&
        Objects.equals(this.url, webhookSubscriptionRow.url) &&
        Objects.equals(this.events, webhookSubscriptionRow.events) &&
        Objects.equals(this.isActive, webhookSubscriptionRow.isActive) &&
        Objects.equals(this.createdAt, webhookSubscriptionRow.createdAt) &&
        Objects.equals(this.updatedAt, webhookSubscriptionRow.updatedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, tenantId, url, events, isActive, createdAt, updatedAt);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WebhookSubscriptionRow {\n");
