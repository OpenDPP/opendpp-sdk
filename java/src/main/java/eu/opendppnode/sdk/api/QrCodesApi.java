...
public class QrCodesApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Void> getBatteryUnitQrCodeWithHttpInfo(String id, String format, Integer size, String ecl, Boolean hri, BigDecimal xDimensionMm) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getBatteryUnitQrCodeRequestBuilder(id, format, size, ecl, hri, xDimensionMm);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder getBatteryUnitQrCodeRequestBuilder(String id, String format, Integer size, String ecl, Boolean hri, BigDecimal xDimensionMm) throws ApiException {
    ...
    localVarQueryParameterBaseName = "xDimensionMm";
    localVarQueryParams.addAll(ApiClient.parameterToPairs("xDimensionMm", xDimensionMm));
   ...
   * @throws ApiException if fails to make API call
   */
  public void getPassportQrCode(String id, String format, Integer size, String ecl, Boolean hri, BigDecimal xDimensionMm) throws ApiException {
    getPassportQrCodeWithHttpInfo(id, format, size, ecl, hri, xDimensionMm);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Void> getPassportQrCodeWithHttpInfo(String id, String format, Integer size, String ecl, Boolean hri, BigDecimal xDimensionMm) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getPassportQrCodeRequestBuilder(id, format, size, ecl, hri, xDimensionMm);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder getPassportQrCodeRequestBuilder(String id, String format, Integer size, String ecl, Boolean hri, BigDecimal xDimensionMm) throws ApiException {
    // verify the required parameter 'id' is set
    if (id == null) {
