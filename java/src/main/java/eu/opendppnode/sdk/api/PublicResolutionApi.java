...
public class PublicResolutionApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PublicPassportJsonLd> resolveGs1GtinWithHttpInfo(String gtin14, String grant, String representation) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = resolveGs1GtinRequestBuilder(gtin14, grant, representation);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder resolveGs1GtinRequestBuilder(String gtin14, String grant, String representation) throws ApiException {
    ...
    localVarQueryParameterBaseName = "grant";
    localVarQueryParams.addAll(ApiClient.parameterToPairs("grant", grant));
    localVarQueryParameterBaseName = "representation";
    localVarQueryParams.addAll(ApiClient.parameterToPairs("representation", representation));
   ...
   * @throws ApiException if fails to make API call
   */
  public void resolveGs1GtinSerial(String gtin14, String serial, String grant, String representation) throws ApiException {
    resolveGs1GtinSerialWithHttpInfo(gtin14, serial, grant, representation);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Void> resolveGs1GtinSerialWithHttpInfo(String gtin14, String serial, String grant, String representation) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = resolveGs1GtinSerialRequestBuilder(gtin14, serial, grant, representation);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder resolveGs1GtinSerialRequestBuilder(String gtin14, String serial, String grant, String representation) throws ApiException {
    // verify the required parameter 'gtin14' is set
    if (gtin14 == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public PublicPassportJsonLd resolvePublicPassport(String id, String grant, String representation) throws ApiException {
    ApiResponse<PublicPassportJsonLd> localVarResponse = resolvePublicPassportWithHttpInfo(id, grant, representation);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PublicPassportJsonLd> resolvePublicPassportWithHttpInfo(String id, String grant, String representation) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = resolvePublicPassportRequestBuilder(id, grant, representation);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder resolvePublicPassportRequestBuilder(String id, String grant, String representation) throws ApiException {
    // verify the required parameter 'id' is set
    if (id == null) {
