...
import eu.opendppnode.sdk.model.AasIngestBadRequest;
...
import eu.opendppnode.sdk.model.PassportBulkBadRequest;
import eu.opendppnode.sdk.model.PassportBulkRequest;
import eu.opendppnode.sdk.model.PassportBulkResult;
import eu.opendppnode.sdk.model.PassportCreateBadRequest;
import eu.opendppnode.sdk.model.PassportCreateRequest;
import eu.opendppnode.sdk.model.PassportGetNotFound;
import eu.opendppnode.sdk.model.PassportGetTooManyRequests;
import eu.opendppnode.sdk.model.PassportHistoryError;
import eu.opendppnode.sdk.model.PassportHistoryList;
import eu.opendppnode.sdk.model.PassportHistoryVersion;
...
import eu.opendppnode.sdk.model.PassportUpdateBadRequest;
...
public class PassportsApi {
   ...
   * @return PassportHistoryVersion
   * @throws ApiException if fails to make API call
   */
  public PassportHistoryVersion getPassportVersion(String id, Integer version) throws ApiException {
    ApiResponse<PassportHistoryVersion> localVarResponse = getPassportVersionWithHttpInfo(id, version);
    return localVarResponse.getData();
  }
   ...
   * @param id Passport UUID, caller-supplied &#x60;productId&#x60; (GTIN-14 / GRAI / SKU) **or** the passport&#39;s own GS1 Digital Link URL (its &#x60;digitalProductPassportId&#x60;, percent-encoded as one path segment). UUID is tried first, then &#x60;productId&#x60;, then the Digital Link — the same lookup as &#x60;GET /api/v1/passports/{id}&#x60;. (required)
   * @param version The archived version number (1 &#x3D; the state the first change replaced). (required)
   * @return ApiResponse&lt;PassportHistoryVersion&gt;
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PassportHistoryVersion> getPassportVersionWithHttpInfo(String id, Integer version) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getPassportVersionRequestBuilder(id, version);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("getPassportVersion", localVarResponse);
        }
        if (localVarResponse.body() == null) {
          return new ApiResponse<PassportHistoryVersion>(
              localVarResponse.statusCode(),
              localVarResponse.headers().map(),
              null
          );
        ...
        return new ApiResponse<PassportHistoryVersion>(
            localVarResponse.statusCode(),
            localVarResponse.headers().map(),
            responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<PassportHistoryVersion>() {})
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder getPassportVersionRequestBuilder(String id, Integer version) throws ApiException {
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getPassportVersion");
    }
    // verify the required parameter 'version' is set
    if (version == null) {
      throw new ApiException(400, "Missing the required parameter 'version' when calling getPassportVersion");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/api/v1/passports/{id}/history/{version}"
        .replace("{id}", ApiClient.urlEncode(id.toString()))
   ...
   * @param id Passport UUID, caller-supplied &#x60;productId&#x60; (GTIN-14 / GRAI / SKU) **or** the passport&#39;s own GS1 Digital Link URL (its &#x60;digitalProductPassportId&#x60;, percent-encoded as one path segment). UUID is tried first, then &#x60;productId&#x60;, then the Digital Link — the same lookup as &#x60;GET /api/v1/passports/{id}&#x60;. (required)
   * @param date The instant to read, as an ISO 8601-1 timestamp with a zone designator — &#x60;Z&#x60; or &#x60;±hh:mm&#x60; (e.g. &#x60;2026-07-15T00:00:00Z&#x60;, &#x60;2026-07-15T02:00:00+02:00&#x60;). A date with no time, a time with no designator, or a calendar-impossible value (&#x60;2026-02-30T00:00:00Z&#x60;) is refused with 400 rather than guessed at. (required)
   * @return PassportHistoryVersion
   * @throws ApiException if fails to make API call
   */
  public PassportHistoryVersion getPassportVersionAtDate(String id, OffsetDateTime date) throws ApiException {
    ApiResponse<PassportHistoryVersion> localVarResponse = getPassportVersionAtDateWithHttpInfo(id, date);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PassportHistoryVersion> getPassportVersionAtDateWithHttpInfo(String id, OffsetDateTime date) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getPassportVersionAtDateRequestBuilder(id, date);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("getPassportVersionAtDate", localVarResponse);
        }
        if (localVarResponse.body() == null) {
          return new ApiResponse<PassportHistoryVersion>(
              localVarResponse.statusCode(),
  ...
  private HttpRequest.Builder getPassportVersionAtDateRequestBuilder(String id, OffsetDateTime date) throws ApiException {
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getPassportVersionAtDate");
    }
    // verify the required parameter 'date' is set
    if (date == null) {
      throw new ApiException(400, "Missing the required parameter 'date' when calling getPassportVersionAtDate");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/api/v1/passports/{id}/history/at"
        .replace("{id}", ApiClient.urlEncode(id.toString()));
   ...
   * @return PassportHistoryList
   * @throws ApiException if fails to make API call
   */
  public PassportHistoryList listPassportHistory(String id, Integer page, Integer limit) throws ApiException {
    ApiResponse<PassportHistoryList> localVarResponse = listPassportHistoryWithHttpInfo(id, page, limit);
    return localVarResponse.getData();
  }
   ...
   * @param page 1-based page number (digits only; non-numeric falls back to 1). (optional, default to 1)
   * @param limit Page size. Clamped to 1–200; non-numeric falls back to the default 100. (optional, default to 100)
   * @return ApiResponse&lt;PassportHistoryList&gt;
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PassportHistoryList> listPassportHistoryWithHttpInfo(String id, Integer page, Integer limit) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = listPassportHistoryRequestBuilder(id, page, limit);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("listPassportHistory", localVarResponse);
        }
        if (localVarResponse.body() == null) {
          return new ApiResponse<PassportHistoryList>(
              localVarResponse.statusCode(),
              localVarResponse.headers().map(),
              null
          );
        ...
        return new ApiResponse<PassportHistoryList>(
            localVarResponse.statusCode(),
            localVarResponse.headers().map(),
            responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<PassportHistoryList>() {})
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder listPassportHistoryRequestBuilder(String id, Integer page, Integer limit) throws ApiException {
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling listPassportHistory");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/api/v1/passports/{id}/history"
        .replace("{id}", ApiClient.urlEncode(id.toString()));
