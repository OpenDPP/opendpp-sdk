...
public class SchemasVocabularyApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Map<String, Object>> getDppVocabularyWithHttpInfo() throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getDppVocabularyRequestBuilder();
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("getDppVocabulary", localVarResponse);
        }
        if (localVarResponse.body() == null) {
        ...
        return new ApiResponse<Map<String, Object>>(
            localVarResponse.statusCode(),
            localVarResponse.headers().map(),
            responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<Map<String, Object>>() {})
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder getDppVocabularyRequestBuilder() throws ApiException {

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/ns/dpp";
