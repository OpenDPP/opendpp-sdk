...
public class EconomicOperatorsApi {
   ...
   * Registers an economic operator (manufacturer, importer, supplier, …) and binds it to your workspace.  **Permission:** &#x60;operator:create&#x60;. Cookie-session clients must send the &#x60;X-CSRF-Token&#x60; header (double-submit); Bearer clients (API key / JWT) are exempt.  **Deduplication (per workspace):** operators are scoped to your workspace — &#x60;regId&#x60; is unique *within* your workspace, not across the platform. If **your workspace** already has an operator with the submitted &#x60;regId&#x60;, that existing record is returned and the submitted &#x60;name&#x60;, &#x60;role&#x60; and &#x60;regIdScheme&#x60; are **ignored**. A &#x60;regId&#x60; already used by *another* workspace is irrelevant — you always get **your own** operator row (so one workspace can never bind to, rename, or archive another&#39;s operator). The call is idempotent: re-registering an already-bound operator succeeds with &#x60;201&#x60; again. The per-workspace match includes **archived** operators: if your workspace&#39;s operator for that &#x60;regId&#x60; is archived, the archived record is returned as-is (&#x60;archivedAt&#x60; non-null) with &#x60;201&#x60; — registration does not un-archive it; use &#x60;POST /api/v1/operators/{id}/restore&#x60; to reactivate it.  **Operator identifier (EN 18219 clause 6):** &#x60;regIdScheme&#x60; is required and names the ISO/IEC 6523 scheme &#x60;regId&#x60; is issued under — &#x60;VAT&#x60; (an EU VAT identification number: member-state prefix + 5–12 alphanumerics), &#x60;DUNS&#x60; (nine digits), &#x60;LEI&#x60; (20 characters, ISO 17442 check digits) or &#x60;GLN&#x60; (13 digits, GS1 check digit); &#x60;regId&#x60; is checked against that shape, and fabricated &#x60;EORI-MOCK…&#x60; ids are rejected on every path. Each scheme has an ICD (0223, 0060, 0199, 0088), which is how the EN 18223 &#x60;economicOperatorId&#x60; is written on every passport. The EORI is a customs identifier with no ICD: send it as the OPTIONAL &#x60;eori&#x60; field, syntax-checked (&#x60;^[A-Z]{2}[A-Za-z0-9]{1,15}$&#x60;). When the node operator enables the OPT-IN EORI existence check, a supplied &#x60;eori&#x60; is additionally checked for EXISTENCE against the EU Commission EOS validation service and, if not found, a NON-BLOCKING advisory is added to the 201 &#x60;warnings[]&#x60; — the operator is still registered (best-effort, fail-open). With the check off, or no &#x60;eori&#x60;, &#x60;warnings&#x60; is &#x60;[]&#x60;.  Side effects: an &#x60;operator.created&#x60; audit event and an in-app notification are recorded.  **Rate limit:** your plan&#39;s per-key budget applies — **Growth** 120/min, **Scale** 600/min, **Enterprise** unlimited — with a ceiling of 3x that rate across all of the workspace&#39;s keys. The per-IP ceiling is not the binding limit for authenticated calls. Standard &#x60;x-ratelimit-*&#x60; headers; **429** carries &#x60;Retry-After&#x60;.
