...
public class BatteryUnitsApi {
   ...
   * Returns the unit&#39;s append-only dynamic-data history ordered by &#x60;recordedAt&#x60; DESC, **capped at the 500 most recent events**. There is no pagination — older events beyond the cap are not retrievable via this endpoint.  **Permission:** &#x60;battery:read&#x60;. Operator-scoped credentials may only read units whose passport belongs to their Economic Operator (403). Events are raw persisted rows (no Fastify response schema, nothing stripped).  **Rate limit:** your plan&#39;s per-key budget applies — **Growth** 120/min, **Scale** 600/min, **Enterprise** unlimited — with a ceiling of 3x that rate across all of the workspace&#39;s keys. The per-IP ceiling is raised for &#x60;Authorization&#x60;-bearing requests, so it is not the binding limit here. Standard &#x60;x-ratelimit-*&#x60; headers; **429** carries &#x60;Retry-After&#x60;.
   * @param id Battery unit UUID (tenant-scoped). (required)
   ...
   * Lists **all** serialised units of the passport, newest first (&#x60;createdAt&#x60; DESC). **Paginated** with &#x60;?page&#x60; (default 1) and &#x60;?limit&#x60; (default 100, max 200) — a SKU may carry many physical units; &#x60;count&#x60; is this page&#39;s size, &#x60;total&#x60;/&#x60;totalPages&#x60; describe the full set.  **Permission:** &#x60;battery:read&#x60;. Operator-scoped credentials may only read passports of their own Economic Operator (403). Units are raw persisted rows (no Fastify response schema, nothing stripped).  **Rate limit:** your plan&#39;s per-key budget applies — **Growth** 120/min, **Scale** 600/min, **Enterprise** unlimited — with a ceiling of 3x that rate across all of the workspace&#39;s keys. The per-IP ceiling is raised for &#x60;Authorization&#x60;-bearing requests, so it is not the binding limit here. Standard &#x60;x-ratelimit-*&#x60; headers; **429** carries &#x60;Retry-After&#x60;.
